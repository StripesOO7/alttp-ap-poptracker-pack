...
tr_main_entrance_inside:connect_two_ways(tr_square_travel_room, function() return all(has("somaria"), can_interact("dark", 1)) end)
...
tr_shooter_after_big_key:connect_two_ways(tr_laser_entrance_inside, function() return all(has("bombs"), can_interact("dark",1 )) end)
...
tr_eye_bridge_entrance_inside:connect_one_way("TR - Eyebridge Top Right", function() return can_interact("dark",1 ) end)
tr_eye_bridge_entrance_inside:connect_one_way("TR - Eyebridge Top Left", function() return can_interact("dark",1 ) end)
tr_eye_bridge_entrance_inside:connect_one_way("TR - Eyebridge Bottom Right", function() return can_interact("dark",1 ) end)
tr_eye_bridge_entrance_inside:connect_one_way("TR - Eyebridge Bottom Left", function() return can_interact("dark",1 ) end)
