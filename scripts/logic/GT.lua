...
local gt_bottom_firesnake_room = alttp_location.new()
...
gt_bottom_main_room:connect_two_ways(gt_bottom_hope_room, function(keys) return has("gt_smallkey", keys + 1, 4, keys + 1, 6) end)
...
gt_bottom_double_switch_room:connect_two_ways(gt_bottom_firesnake_room, function(keys) return has("gt_smallkey", keys, 3, keys + 1, 5)end)
...
gt_bottom_firesnake_room:connect_two_ways(gt_bottom_teleporter_puzzle_room, function(keys) return has("gt_smallkey", keys + 1, 3, keys + 1, 5) end)
...
gt_bottom_tile_room:connect_two_ways(gt_bottom_torch_puzzle, function() return has("gt_smallkey", keys + 1, 2, keys + 1, 4) end)
...
gt_bottom_conveyor_star_room:connect_one_way(gt_bottom_invisibile_bonk_room, function(keys) return has("gt_smallkey", keys + 1, 2, keys + 1, 5) end)
...
gt_top_pre_moldorm_room:connect_one_way(gt_top_top_refight, function(keys) return has("gt_smallkey", keys + 1, 4, keys + 1, 7) end)
