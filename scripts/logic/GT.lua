...
gt_entrance:connect_two_ways(gt_bottom_main_room, function() return all(can_interact("dark"), openOrStandard()) end)
gt_entrance:connect_two_ways(gt_bottom_main_room, function() return all(can_interact("light"), inverted()) end)
