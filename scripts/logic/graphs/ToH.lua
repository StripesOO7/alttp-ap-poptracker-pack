...
local ToH_fairy_drop = alttp_location.new("ToH_fairy_drop", "ToH Boss Floor", nil, "ToH", true)
...
ToH_tridorm_room:connect_one_way("ToH - Tridorm Enemy #1", function() return DealDamage end)
-- ToH_tridorm_room:connect_one_way("ToH - Tridorm Enemy #2", function() return DealDamage end)
-- ToH_tridorm_room:connect_one_way("ToH - Tridorm Enemy #3", function() return DealDamage end)
...
ToH_big_key_chest:connect_one_way("ToH - Torches Enemy #10", function() return DealDamage end)
-- ToH_big_key_chest:connect_one_way("ToH - Torches Enemy #13", function() return DealDamage end)
...
ToH_basement_cage:connect_one_way("ToH - Basement Cage Enemy #4", function() return DealDamage end)
-- ToH_basement_cage:connect_one_way("ToH - Basement Cage Enemy #11", function() return DealDamage end)
-- ToH_basement_cage:connect_one_way("ToH - Basement Cage Enemy #12", function() return DealDamage end)
-- ToH_basement_cage:connect_one_way("ToH - Basement Cage Enemy #9", function() return DealDamage end)
...
ToH_3_hard_head_beatles:connect_one_way("ToH - Beetles Enemy #8", function() return DealDamage end)
-- ToH_3_hard_head_beatles:connect_one_way("ToH - Beetles Enemy #9", function() return DealDamage end)
-- ToH_3_hard_head_beatles:connect_one_way("ToH - Beetles Enemy #11", function() return DealDamage end)
...
ToH_big_key_door_room:connect_one_way("ToH - Startile Corner Enemy #7", function() return DealDamage end)
-- ToH_big_key_door_room:connect_one_way("ToH - Startile Corner Enemy #10", function() return DealDamage end)
-- ToH_big_key_door_room:connect_one_way("ToH - Startile Corner Enemy #12", function() return DealDamage end)
...
ToH_startile_wide:connect_one_way("ToH - Startile Wide Enemy #3", function() return DealDamage end)
-- ToH_startile_wide:connect_one_way("ToH - Startile Wide Enemy #4", function() return DealDamage end)
-- ToH_startile_wide:connect_one_way("ToH - Startile Wide Enemy #5", function() return DealDamage end)
-- ToH_startile_wide:connect_one_way("ToH - Startile Wide Enemy #6", function() return DealDamage end)
...
ToH_big_chest_room:connect_one_way("ToH - 4F Enemy #1", function() return DealDamage end)
-- ToH_big_chest_room:connect_one_way("ToH - 4F Enemy #2", function() return DealDamage end)
-- ToH_big_chest_room:connect_one_way("ToH - 4F Enemy #3", function() return DealDamage end)
-- ToH_big_chest_room:connect_one_way("ToH - 4F Enemy #4", function() return DealDamage end)
-- ToH_big_chest_room:connect_one_way("ToH - 4F Enemy #6", function() return DealDamage end)
-- ToH_big_chest_room:connect_one_way("ToH - 4F Enemy #7", function() return DealDamage end)
...
ToH_big_chest_platform:connect_one_way("ToH - Big Chest Landing Enemy #5", function() return DealDamage end)
...
ToH_5F_orange_path:connect_one_way("ToH - 5F Enemy #1", function() return DealDamage end)
-- ToH_5F_orange_path:connect_one_way("ToH - 5F Enemy #2", function() return DealDamage end)
-- ToH_5F_orange_path:connect_one_way("ToH - 5F Enemy #3", function() return DealDamage end)
-- ToH_5F_orange_path:connect_one_way("ToH - 5F Enemy #4", function() return DealDamage end)
-- ToH_5F_orange_path:connect_one_way("ToH - 5F Enemy #5", function() return DealDamage end)
-- ToH_5F_orange_path:connect_one_way("ToH - 5F Enemy #6", function() return DealDamage end)
-- ToH_5F_orange_path:connect_one_way("ToH - 5F Enemy #7", function() return DealDamage end)
-- ToH_5F_orange_path:connect_one_way("ToH - 5F Enemy #8", function() return DealDamage end)
-- ToH_5F_orange_path:connect_one_way("ToH - 5F Enemy #9", function() return DealDamage end)
...
ToH_fairy_drop:connect_one_way("ToH - Fairies Enemy #1", function() return DealDamage end)
-- ToH_fairy_drop:connect_one_way("ToH - Fairies Enemy #2", function() return DealDamage end)
