...
ToH_main_room_1N_door = alttp_location.new("ToH_main_room_1N_door", "ToH Main Room 1N Door", nil, "", true, 1,1,1,1, nil, {"Tower of Hera Doors", "ToH Main Room 1N Door", "ToH Main Room 1N Door"})
ToH_main_room_3N_door = alttp_location.new("ToH_main_room_3N_door", "ToH Main Room 3N Door", nil, "", true, 1,1,1,1, nil, {"Tower of Hera Doors", "ToH Main Room 3N Door", "ToH Main Room 3N Door"})
ToH_main_room_4N_door = alttp_location.new("ToH_main_room_4N_door", "ToH Main Room 4N Door", nil, "", true, 1,1,1,1, nil, {"Tower of Hera Doors", "ToH Main Room 4N Door", "ToH Main Room 4N Door"})
ToH_basement_cage_3N_door = alttp_location.new("ToH_basement_cage_3N_door", "ToH Basement Cage 3N Door", nil, "", true, 1,1,1,1, nil, {"Tower of Hera Doors", "ToH Basement Cage 3N Door", "ToH Basement Cage 3N Door"})
ToH_tile_room_1N_door = alttp_location.new("ToH_tile_room_1N_door", "ToH Tile Room 1N Door", nil, "", true, 1,1,1,1, nil, {"Tower of Hera Doors", "ToH Tile Room 1N Door", "ToH Tile Room 1N Door"})
ToH_3_hard_head_beatles_4N_door = alttp_location.new("ToH_3_hard_head_beatles_4N_door", "ToH 3 Hard Head Beatles 4N Door", nil, "", true, 1,1,1,1, nil, {"Tower of Hera Doors", "ToH 3 Hard Head Beatles 4N Door", "ToH 3 Hard Head Beatles 4N Door"})
ToH_startile_wide_2N_door = alttp_location.new("ToH_startile_wide_2N_door", "ToH Startile Wide 2N Door", nil, "", true, 1,1,1,1, nil, {"Tower of Hera Doors", "ToH Startile Wide 2N Door", "ToH Startile Wide 2N Door"})
ToH_big_chest_room_1N_door = alttp_location.new("ToH_big_chest_room_1N_door", "ToH Big Chest Room 1N Door", nil, "", true, 1,1,1,1, nil, {"Tower of Hera Doors", "ToH Big Chest Room 1N Door", "ToH Big Chest Room 1N Door"})
ToH_big_chest_room_2N_door = alttp_location.new("ToH_big_chest_room_2N_door", "ToH Big Chest Room 2N Door", nil, "", true, 1,1,1,1, nil, {"Tower of Hera Doors", "ToH Big Chest Room 2N Door", "ToH Big Chest Room 2N Door"})
ToH_5F_orange_path_1N_door = alttp_location.new("ToH_5F_orange_path_1N_door", "ToH 5F Orange Path 1N Door", nil, "", true, 1,1,1,1, nil, {"Tower of Hera Doors", "ToH 5F Orange Path 1N Door", "ToH 5F Orange Path 1N Door"})
ToH_5F_orange_path_2N_door = alttp_location.new("ToH_5F_orange_path_2N_door", "ToH 5F Orange Path 2N Door", nil, "", true, 1,1,1,1, nil, {"Tower of Hera Doors", "ToH 5F Orange Path 2N Door", "ToH 5F Orange Path 2N Door"})
ToH_boss_room_2N_door = alttp_location.new("ToH_boss_room_2N_door", "ToH Boss Room 2N Door", nil, "", true, 1,1,1,1, nil, {"Tower of Hera Doors", "ToH Boss Room 2N Door", "ToH Boss Room 2N Door"})
