...
local TR_big_key_room_pipe_after_big_key = alttp_location.new("TR_big_key_room_pipe_after_big_key", "TR Pipes Bottom Left To Top Right", nil, "TR", true)
...
local TR_main_entrance_pre_gap = alttp_location.new("TR_main_entrance_pre_gap", "TR Main Entrance Pre Gap")
local TR_main_entrance_post_gap = alttp_location.new("TR_main_entrance_post_gap", "TR Main Entrance Post Gap")
local TR_tile_room = alttp_location.new("TR_tile_room", "TR Tile Room")
local TR_refill_room = alttp_location.new("TR_refill_room", "TR Refill Room")
local TR_torch_puzzle_deadend = alttp_location.new("TR_torch_puzzle_deadend", "TR Torch Puzzle Deadend")
local TR_pipe_pit = alttp_location.new("TR_pipe_pit", "TR Pipe Pit")
local TR_pipe_pit_bottom_left_ledge = alttp_location.new("TR_pipe_pit_bottom_left_ledge", "TR Pipe Pit Bottom Left Ledge")
local TR_pipe_pit_center_ledge = alttp_location.new("TR_pipe_pit_center_ledge", "TR Pipe Pit Center Ledge")
local TR_double_poke_room = alttp_location.new("TR_double_poke_room", "TR Double Poke Room")
local TR_small_t_hallway = alttp_location.new("TR_small_t_hallway", "TR Ssmall T Hallway")
local TR_big_chest_ledge = alttp_location.new("TR_big_chest_ledge", "TR Big Chest Ledge")
local TR_big_chest_below_pit = alttp_location.new("TR_big_chest_below_pit", "TR Big Chest Below Pit")
local TR_big_chest_above_pit = alttp_location.new("TR_big_chest_above_pit", "TR Big Chest Above Pit")
local TR_snake_trap_room = alttp_location.new("TR_snake_trap_room", "TR Snake Trap Room")
local TR_rupee_room = alttp_location.new("TR_rupee_room", "TR Rupee Room")
local TR_crystal_maze = alttp_location.new("TR_crystasl_maze", "TR Crystal Maze")
local TR_pre_boss_below_pit = alttp_location.new("TR_pre_boss_below_pit", "TR Pre Boss Below Pit")
local TR_pre_boss_above_pit = alttp_location.new("TR_pre_boss_above_pit", "TR Pre Boss Above Pit")

TR_main_entrance_post_gap_2N_door = alttp_location.new("TR_main_entrance_post_gap_2N_door", "TR Main Entrance Post Gap 2N Door", nil, "", true, 214, 3448, 3448, 6640, 6690, {"Trutle Rock Front Doors", "TR Main Entrance Post Gap 2N Door", "TR Main Entrance Post Gap 2N Door"})
TR_square_travel_room_1N_door = alttp_location.new("TR_square_travel_room_1N_door", "TR Square Travel Room 1N Door", nil, "", true, 198, 3192, 3192, 6130, 6190, {"Trutle Rock Front Doors", "TR Square Travel Room 1N Door", "TR Square Travel Room 1N Door"})
TR_square_travel_room_2N_door = alttp_location.new("TR_square_travel_room_2N_door", "TR Square Travel Room 2N Door", nil, "", true, 198, 3448, 3448, 6130, 6190, {"Trutle Rock Front Doors", "TR Square Travel Room 2N Door", "TR Square Travel Room 2N Door"})
TR_square_travel_room_2E_door = alttp_location.new("TR_square_travel_room_2E_door", "TR Square Travel Room 2E Door", nil, "", true, 198, 2530, 2590, 6264, 6264, {"Trutle Rock Front Doors", "TR Square Travel Room 2E Door", "TR Square Travel Room 2E Door"})
TR_square_travel_room_3S_door = alttp_location.new("TR_square_travel_room_3S_door", "TR Square Travel Room 3S Door", nil, "", true, 198, 3192, 3192, 6610, 6680, {"Trutle Rock Front Doors", "TR Square Travel Room 3S Door", "TR Square Travel Room 3S Door"})
TR_square_travel_room_4E_door = alttp_location.new("TR_square_travel_room_4E_door", "TR Square Travel Room 4E Door", nil, "", true, 198, 2530, 2590, 6520, 6520, {"Trutle Rock Front Doors", "TR Square Travel Room 4E Door", "TR Square Travel Room 4E Door"})
TR_square_travel_room_4S_door = alttp_location.new("TR_square_travel_room_4S_door", "TR Square Travel Room 4S Door", nil, "", true, 198, 3448, 3448, 6610, 6680, {"Trutle Rock Front Doors", "TR Square Travel Room 4S Door", "TR Square Travel Room 4S Door"})
TR_compass_room_1N_door = alttp_location.new("TR_compass_room_1N_door", "TR Compass Room 1N Door", nil, "", true, 214, 3192, 3192, 6640, 6690, {"Trutle Rock Front Doors", "TR Compass Room 1N Door", "TR Compass Room 1N Door"})
TR_tile_room_4S_door = alttp_location.new("TR_tile_room_4S_door", "TR Tile Room 4S Door", nil, "", true, 182, 3448, 3448, 6100, 6170, {"Trutle Rock Front Doors", "TR Tile Room 4S Door", "TR Tile Room 4S Door"})
TR_torch_puzzle_1W_door = alttp_location.new("TR_torch_puzzle_1W_door", "TR Torch Puzzle 1W Door", nil, "", true, 199, 3560, 3610, 6264, 6264, {"Trutle Rock Front Doors", "TR Torch Puzzle 1W Door", "TR Torch Puzzle 1W Door"})
TR_torch_puzzle_1N_door = alttp_location.new("TR_torch_puzzle_1N_door", "TR Torch Puzzle 1N Door", nil, "", true, 199, 3704, 3704, 6130, 6190, {"Trutle Rock Front Doors", "TR Torch Puzzle 1N Door", "TR Torch Puzzle 1N Door"})
TR_map_room_3S_door = alttp_location.new("TR_map_room_3S_door", "TR Map Room 3S Door", nil, "", true, 183, 3704, 3704, 6100, 6170, {"Trutle Rock Front Doors", "TR Map Room 3S Door", "TR Map Room 3S Door"})
TR_torch_puzzle_deadend_3W_door = alttp_location.new("TR_torch_puzzle_deadend_3W_door", "TR Torch Puzzle Deadend 3W Door", nil, "", true, 199, 3560, 3610, 6520, 6520, {"Trutle Rock Front Doors", "TR Torch Puzzle Deadend 3W Door", "TR Torch Puzzle Deadend 3W Door"})
TR_poke_1_room_3S_door = alttp_location.new("TR_poke_1_room_3S_door", "TR Poke 1 Room 3S Door", nil, "", true, 182, 3192, 3192, 6100, 6170, {"Trutle Rock Back Doors", "TR Poke 1 Room 3S Door", "TR Poke 1 Room 3S Door"})
TR_chain_chomps_room_1N_door = alttp_location.new("TR_chain_chomps_room_1N_door", "TR Chain Chomps Room 1N Door", nil, "", true, 182, 3192, 3192, 5650, 5690, {"Trutle Rock Front Doors", "TR Chain Chomps Room 1N Door", "TR Chain Chomps Room 1N Door"})
TR_pipe_pit_1N_door = alttp_location.new("TR_pipe_pit_1N_door", "TR Pipe Pit 1N Door", nil, "", true, 21, 2680, 2680, 540, 560, {"Trutle Rock Front Doors", "TR Pipe Pit 1N Door", "TR Pipe Pit 1N Door"})
TR_pipe_pit_1W_door = alttp_location.new("TR_pipe_pit_1W_door", "TR Pipe Pit 1W Door", nil, "", true, 21, 2540, 2590, 632, 632, {"Trutle Rock Front Doors", "TR Pipe Pit 1W Door", "TR Pipe Pit 1W Door"})
TR_pipe_pit_bottom_left_ledge_3W_door = alttp_location.new("TR_pipe_pit_bottom_left_ledge_3W_door", "TR Pipe Pit Bottom Left Ledge 3W Door", nil, "", true, 21, 2540, 2590, 888, 888, {"Trutle Rock Front Doors", "TR Pipe Pit Bottom Left Ledge 3W Door", "TR Pipe Pit Bottom Left Ledge 3W Door"})
TR_big_key_room_top_right_2E_door = alttp_location.new("TR_big_key_room_top_right_2E_door", "TR Big Key Room Top Right 2E Door", nil, "", true, 20, 2520, 2570, 632, 632, {"Trutle Rock Front Doors", "TR Big Key Room Top Right 2E Door", "TR Big Key Room Top Right 2E Door"})
TR_big_key_room_top_left_1W_door = alttp_location.new("TR_big_key_room_top_left_1W_door", "TR Big Key Room Top Left 1W Door", nil, "", true, 20, 2030, 2070, 632, 632, {"Trutle Rock Front Doors", "TR Big Key Room Top Left 1W Door", "TR Big Key Room Top Left 1W Door"})
TR_big_key_room_top_left_1N_door = alttp_location.new("TR_big_key_room_top_left_1N_door", "TR Big Key Room Top Left 1N Door", nil, "", true, 20, 2168, 2168, 490, 5501, {"Trutle Rock Front Doors", "TR Big Key Room Top Left 1N Door", "TR Big Key Room Top Left 1N Door"})
TR_big_key_room_bottom_right_4E_door = alttp_location.new("TR_big_key_room_bottom_right_4E_door", "TR Big Key Room Bottom Right 4E Door", nil, "", true, 20, 2520, 2570, 888, 888, {"Trutle Rock Front Doors", "TR Big Key Room Bottom Right 4E Door", "TR Big Key Room Bottom Right 4E Door"})
TR_big_key_room_bottom_right_4S_door = alttp_location.new("TR_big_key_room_bottom_right_4S_door", "TR Big Key Room Bottom Right 4S Door", nil, "", true, 20, 2424, 2424, 980, 1050, {"Trutle Rock Front Doors", "TR Big Key Room Bottom Right 4S Door", "TR Big Key Room Bottom Right 4S Door"})
TR_big_key_room_bottom_left_3W_door = alttp_location.new("TR_big_key_room_bottom_left_3W_door", "TR Big Key Room Bottom Left 3W Door", nil, "", true, 20, 2030, 2070, 888, 888, {"Trutle Rock Front Doors", "TR Big Key Room Bottom Left 3W Door", "TR Big Key Room Bottom Left 3W Door"})
TR_big_key_room_bottom_left_3S_door = alttp_location.new("TR_big_key_room_bottom_left_3S_door", "TR Big Key Room Bottom Left 3S Door", nil, "", true, 20, 2168, 2168, 980, 1050, {"Trutle Rock Front Doors", "TR Big Key Room Bottom Left 3S Door", "TR Big Key Room Bottom Left 3S Door"})
TR_poke_2_room_2E_door = alttp_location.new("TR_poke_2_room_2E_door", "TR Poke 2 Room_2E Door", nil, "", true, 19, 2010, 2060, 632, 632, {"Trutle Rock Front Doors", "TR Poke 2 Room_2E Door", "TR Poke 2 Room_2E Door"})
TR_poke_2_room_4E_door = alttp_location.new("TR_poke_2_room_4E_door", "TR Poke 2 Room_4E Door", nil, "", true, 19, 2010, 2060, 888, 888, {"Trutle Rock Front Doors", "TR Poke 2 Room_4E Door", "TR Poke 2 Room_4E Door"})
TR_double_poke_room_1N_door = alttp_location.new("TR_double_poke_room_1N_door", "TR Double Poke Room_1N Door", nil, "", true, 36, 2168, 2168, 1000, 1060, {"Trutle Rock Front Doors", "TR Double Poke Room_1N Door", "TR Double Poke Room_1N Door"})
TR_small_t_hallway_3W_door = alttp_location.new("TR_small_t_hallway_3W_door", "TR Small T Hallway 3W Door", nil, "", true, 36, 2030, 2070, 1400, 1400, {"Trutle Rock Front Doors", "TR Small T Hallway 3E Door", "TR Small T Hallway 3E Door"})
TR_laser_entrance_room_4E_door = alttp_location.new("TR_laser_entrance_room_4E_door", "TR Laser Entrance Room 4E Door", nil, "", true, 35, 2010, 2060, 1400, 1400, {"Trutle Rock Front Doors", "TR Laser Entrance Room 4E Door", "TR Laser Entrance Room 4E Door"})
TR_big_keydoor_room_2N_door = alttp_location.new("TR_big_keydoor_room_2N_door", "TR Big Key Door Room 2N Door", nil, "", true, 36, 2424, 2424, 1000, 1060, {"Trutle Rock Front Doors", "TR Big Key Door Room 2N Door", "TR Big Key Door Room 2N Door"})
TR_pokes_after_bigdoor_3S_door = alttp_location.new("TR_pokes_after_bigdoor_3S_door", "TR Pokes After Big Door 3S Door", nil, "", true, 4, 2168, 2168, 460, 510, {"Trutle Rock Front Doors", "TR Pokes After Big Door 3S Door", "TR Pokes After Big Door 3S Door"})
TR_crystalroller_room_1N_door = alttp_location.new("TR_crystalroller_room_1N_door", "TR Crystalroller Room 1N Door", nil, "", true, 4, 2168, 2168, 20, 50, {"Trutle Rock Back Doors", "TR Crystalroller Room 1N Door", "TR Crystalroller Room 1N Door"})
TR_travel_maze_1N_door = alttp_location.new("TR_travel_maze_1N_door", "TR Travel Maze 1N Door", nil, "", true, 181, 2680, 2680, 5665, 5685, {"Trutle Rock Back Doors", "TR Travel Maze 1N Door", "TR Travel Maze 1N Door"})
TR_travel_maze_3S_door = alttp_location.new("TR_travel_maze_3S_door", "TR Travel Maze 3S Door", nil, "", true, 181, 2680, 2680, 6090, 6170, {"Trutle Rock Back Doors", "TR Travel Maze 3S Door", "TR Travel Maze 3S Door"})
TR_side_eye_hallway_1N_door = alttp_location.new("TR_side_eye_hallway_1N_door", "TR Side Eye Hallway 1N Door", nil, "", true, 197, 2680, 2680, 6120, 6190, {"Trutle Rock Back Doors", "TR Side Eye Hallway 1N Door", "TR Side Eye Hallway 1N Door"})
TR_side_eye_hallway_3S_door = alttp_location.new("TR_side_eye_hallway_3S_door", "TR Side Eye Hallway 3S Door", nil, "", true, 197, 2680, 2680, 6620, 6680, {"Trutle Rock Back Doors", "TR Side Eye Hallway 3S Door", "TR Side Eye Hallway 3S Door"})
TR_side_eye_hallway_3W_door = alttp_location.new("TR_side_eye_hallway_3W_door", "TR Side Eye Hallway 3W Door", nil, "", true, 197, 2540, 2580, 6520, 6520, {"Trutle Rock Back Doors", "TR Side Eye Hallway 3W Door", "TR Side Eye Hallway 3W Door"})
TR_eye_bridge_1N_door = alttp_location.new("TR_eye_bridge_1N_door", "TR Eye Bridge 1N Door", nil, "", true, 213, 2680, 2680, 6640, 6690, {"Trutle Rock Back Doors", "TR Eye Bridge 1N Door", "TR Eye Bridge 1N Door"})
TR_crystal_maze_N_door = alttp_location.new("TR_crystal_maze_N_door", "TR Crystal Maze N Door", nil, "", true, 196, 2296, 2296, 6170, 6210, {"Trutle Rock Back Doors", "TR Crystal Maze N Door", "TR Crystal Maze N Door"})
TR_crystal_maze_4E_door = alttp_location.new("TR_crystal_maze_4E_door", "TR Crystal Maze 4E Door", nil, "", true, 196, 2520, 2570, 6520, 6520, {"Trutle Rock Back Doors", "TR Crystal Maze 4E Door", "TR Crystal Maze 4E Door"})
TR_pre_boss_pit_S_door = alttp_location.new("TR_pre_boss_pit_S_door", "TR Pre Boss Pit S Door", nil, "", true, 180, 2296, 2296, 6070, 6100, {"Trutle Rock Back Doors", "TR Pre Boss Pit S Door", "TR Pre Boss Pit S Door"})
TR_pre_boss_pit_1N_door = alttp_location.new("TR_pre_boss_pit_1N_door", "TR Pre Boss Pit 1N Door", nil, "", true, 180, 2168, 2168, 5610, 5670, {"Trutle Rock Back Doors", "TR Pre Boss Pit 1N Door", "TR Pre Boss Pit 1N Door"})
TR_boss_room_3S_door = alttp_location.new("TR_boss_room_3S_door", "TR Boss Room 3S Door", nil, "", true, 164, 2168, 2168, 5620, 5670, {"Trutle Rock Back Doors", "TR Boss Room 3S Door", "TR Boss Room 3S Door"})
...
TR_square_travel_room:connect_two_ways(TR_square_travel_room_2E_door, function() return Has("somaria") end)
TR_square_travel_room:connect_two_ways(TR_square_travel_room_3S_door, function() return Has("somaria") end)
TR_square_travel_room:connect_two_ways(TR_square_travel_room_4E_door, function() return Has("somaria") end)

TR_square_travel_room_3S_door:connect_two_ways_entrance("", TR_compass_room_1N_door)
TR_compass_room_1N_door:connect_two_ways(TR_compass_room)
...
TR_big_key_room_top_right_2E_door:connect_two_ways(TR_big_key_room_top_right)
TR_big_key_room_top_right:connect_two_ways(TR_big_key_room_top_left_1W_door)
...
TR_big_chest_above_pit:connect_two_ways_stuck(TR_big_key_door_room, nil, function() return false end)

-- TR_big_chest_below_pit:connect_one_way(TR_big_chest_ledge)

TR_big_key_door_room:connect_two_ways(TR_big_keydoor_room_2N_door)
TR_big_keydoor_room_2N_door:connect_two_ways_entrance_door_stuck("", TR_big_key_room_bottom_right_4S_door, function() return Has("bigkey") end, function(keys, Current_Dungeon) return false end) --smallkeydoor unconsidered
