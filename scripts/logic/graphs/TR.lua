...
TR_main_entrance_post_gap_2N_door = alttp_location.new("TR_main_entrance_post_gap_2N_door", "TR Main Entrance Post Gap 2N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Main Entrance Post Gap 2N Door", "TR Main Entrance Post Gap 2N Door"})
TR_square_travel_room_1N_door = alttp_location.new("TR_square_travel_room_1N_door", "TR Square Travel Room 1N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Square Travel Room 1N Door", "TR Square Travel Room 1N Door"})
TR_square_travel_room_2N_door = alttp_location.new("TR_square_travel_room_2N_door", "TR Square Travel Room 2N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Square Travel Room 2N Door", "TR Square Travel Room 2N Door"})
TR_square_travel_room_2E_door = alttp_location.new("TR_square_travel_room_2E_door", "TR Square Travel Room 2E Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Square Travel Room 2E Door", "TR Square Travel Room 2E Door"})
TR_square_travel_room_3S_door = alttp_location.new("TR_square_travel_room_3S_door", "TR Square Travel Room 3S Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Square Travel Room 3S Door", "TR Square Travel Room 3S Door"})
TR_square_travel_room_4E_door = alttp_location.new("TR_square_travel_room_4E_door", "TR Square Travel Room 4E Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Square Travel Room 4E Door", "TR Square Travel Room 4E Door"})
TR_square_travel_room_4S_door = alttp_location.new("TR_square_travel_room_4S_door", "TR Square Travel Room 4S Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Square Travel Room 4S Door", "TR Square Travel Room 4S Door"})
TR_compass_room_1N_door = alttp_location.new("TR_compass_room_1N_door", "TR Compass Room 1N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Compass Room 1N Door", "TR Compass Room 1N Door"})
TR_tile_room_4S_door = alttp_location.new("TR_tile_room_4S_door", "TR Tile Room 4S Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Tile Room 4S Door", "TR Tile Room 4S Door"})
TR_torch_puzzle_1W_door = alttp_location.new("TR_torch_puzzle_1W_door", "TR Torch Puzzle 1W Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Torch Puzzle 1W Door", "TR Torch Puzzle 1W Door"})
TR_torch_puzzle_1N_door = alttp_location.new("TR_torch_puzzle_1N_door", "TR Torch Puzzle 1N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Torch Puzzle 1N Door", "TR Torch Puzzle 1N Door"})
TR_map_room_3S_door = alttp_location.new("TR_map_room_3S_door", "TR Map Room 3S Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Map Room 3S Door", "TR Map Room 3S Door"})
TR_torch_puzzle_deadend_3E_door = alttp_location.new("TR_torch_puzzle_deadend_3E_door", "TR Torch Puzzle Deadend 3E Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Torch Puzzle Deadend 3E Door", "TR Torch Puzzle Deadend 3E Door"})
TR_chain_chomps_room_1N_door = alttp_location.new("TR_chain_chomps_room_1N_door", "TR Chain Chomps Room 1N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Chain Chomps Room 1N Door", "TR Chain Chomps Room 1N Door"})
TR_pipe_pit_1N_door = alttp_location.new("TR_pipe_pit_1N_door", "TR Pipe Pit 1N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Pipe Pit 1N Door", "TR Pipe Pit 1N Door"})
TR_pipe_pit_1W_door = alttp_location.new("TR_pipe_pit_1W_door", "TR Pipe Pit 1W Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Pipe Pit 1W Door", "TR Pipe Pit 1W Door"})
TR_pipe_pit_bottom_left_ledge_3W_door = alttp_location.new("TR_pipe_pit_bottom_left_ledge_3W_door", "TR Pipe Pit Bottom Left Ledge 3W Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Pipe Pit Bottom Left Ledge 3W Door", "TR Pipe Pit Bottom Left Ledge 3W Door"})
TR_big_key_room_top_right_2E_door = alttp_location.new("TR_big_key_room_top_right_2E_door", "TR Big Key Room Top Right 2E Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Big Key Room Top Right 2E Door", "TR Big Key Room Top Right 2E Door"})
TR_big_key_room_top_left_1W_door = alttp_location.new("TR_big_key_room_top_left_1W_door", "TR Big Key Room Top Left 1W Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Big Key Room Top Left 1W Door", "TR Big Key Room Top Left 1W Door"})
TR_big_key_room_top_left_1N_door = alttp_location.new("TR_big_key_room_top_left_1N_door", "TR Big Key Room Top Left 1N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Big Key Room Top Left 1N Door", "TR Big Key Room Top Left 1N Door"})
TR_big_key_room_bottom_right_4E_door = alttp_location.new("TR_big_key_room_bottom_right_4E_door", "TR Big Key Room Bottom Right 4E Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Big Key Room Bottom Right 4E Door", "TR Big Key Room Bottom Right 4E Door"})
TR_big_key_room_bottom_right_4S_door = alttp_location.new("TR_big_key_room_bottom_right_4S_door", "TR Big Key Room Bottom Right 4S Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Big Key Room Bottom Right 4S Door", "TR Big Key Room Bottom Right 4S Door"})
TR_big_key_room_bottom_left_3W_door = alttp_location.new("TR_big_key_room_bottom_left_3W_door", "TR Big Key Room Bottom Left 3W Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Big Key Room Bottom Left 3W Door", "TR Big Key Room Bottom Left 3W Door"})
TR_big_key_room_bottom_left_3S_door = alttp_location.new("TR_big_key_room_bottom_left_3S_door", "TR Big Key Room Bottom Left 3S Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Big Key Room Bottom Left 3S Door", "TR Big Key Room Bottom Left 3S Door"})
TR_poke_2_room_2E_door = alttp_location.new("TR_poke_2_room_2E_door", "TR Poke 2 Room_2E Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Poke 2 Room_2E Door", "TR Poke 2 Room_2E Door"})
TR_poke_2_room_4E_door = alttp_location.new("TR_poke_2_room_4E_door", "TR Poke 2 Room_4E Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Poke 2 Room_4E Door", "TR Poke 2 Room_4E Door"})
TR_double_poke_room_1N_door = alttp_location.new("TR_double_poke_room_1N_door", "TR Double Poke Room_1N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Double Poke Room_1N Door", "TR Double Poke Room_1N Door"})
TR_small_t_hallway_3E_door = alttp_location.new("TR_small_t_hallway_3E_door", "TR Small T Hallway 3E Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Small T Hallway 3E Door", "TR Small T Hallway 3E Door"})
TR_laser_entrance_room_4E_door = alttp_location.new("TR_laser_entrance_room_4E_door", "TR Laser Entrance Room 4E Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Laser Entrance Room 4E Door", "TR Laser Entrance Room 4E Door"})
TR_big_keydoor_room_2N_door = alttp_location.new("TR_big_keydoor_room_2N_door", "TR Big Key Door Room 2N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Big Key Door Room 2N Door", "TR Big Key Door Room 2N Door"})
TR_pokes_after_bigdoor_3S_door = alttp_location.new("TR_pokes_after_bigdoor_3S_door", "TR Pokes After Big Door 3S Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Front Doors", "TR Pokes After Big Door 3S Door", "TR Pokes After Big Door 3S Door"})
TR_crystalroller_room_1N_door = alttp_location.new("TR_crystalroller_room_1N_door", "TR Crystalroller Room 1N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Back Doors", "TR Crystalroller Room 1N Door", "TR Crystalroller Room 1N Door"})
TR_travel_maze_1N_door = alttp_location.new("TR_travel_maze_1N_door", "TR Travel Maze 1N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Back Doors", "TR Travel Maze 1N Door", "TR Travel Maze 1N Door"})
TR_travel_maze_3S_door = alttp_location.new("TR_travel_maze_3S_door", "TR Travel Maze 3S Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Back Doors", "TR Travel Maze 3S Door", "TR Travel Maze 3S Door"})
TR_side_eye_hallway_1N_door = alttp_location.new("TR_side_eye_hallway_1N_door", "TR Side Eye Hallway 1N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Back Doors", "TR Side Eye Hallway 1N Door", "TR Side Eye Hallway 1N Door"})
TR_side_eye_hallway_3S_door = alttp_location.new("TR_side_eye_hallway_3S_door", "TR Side Eye Hallway 3S Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Back Doors", "TR Side Eye Hallway 3S Door", "TR Side Eye Hallway 3S Door"})
TR_side_eye_hallway_3W_door = alttp_location.new("TR_side_eye_hallway_3W_door", "TR Side Eye Hallway 3W Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Back Doors", "TR Side Eye Hallway 3W Door", "TR Side Eye Hallway 3W Door"})
TR_eye_bridge_1N_door = alttp_location.new("TR_eye_bridge_1N_door", "TR Eye Bridge 1N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Back Doors", "TR Eye Bridge 1N Door", "TR Eye Bridge 1N Door"})
TR_crystal_maze_N_door = alttp_location.new("TR_crystal_maze_N_door", "TR Crystal Maze N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Back Doors", "TR Crystal Maze N Door", "TR Crystal Maze N Door"})
TR_crystal_maze_4E_door = alttp_location.new("TR_crystal_maze_4E_door", "TR Crystal Maze 4E Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Back Doors", "TR Crystal Maze 4E Door", "TR Crystal Maze 4E Door"})
TR_pre_boss_pit_S_door = alttp_location.new("TR_pre_boss_pit_S_door", "TR Pre Boss Pit S Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Back Doors", "TR Pre Boss Pit S Door", "TR Pre Boss Pit S Door"})
TR_pre_boss_pit_1N_door = alttp_location.new("TR_pre_boss_pit_1N_door", "TR Pre Boss Pit 1N Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Back Doors", "TR Pre Boss Pit 1N Door", "TR Pre Boss Pit 1N Door"})
TR_boss_room_3S_door = alttp_location.new("TR_boss_room_3S_door", "TR Boss Room 3S Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Back Doors", "TR Boss Room 3S Door", "TR Boss Room 3S Door"})
TR_poke_1_room_3S_door = alttp_location.new("TR_poke_1_room_3S_door", "TR Poke 1 Room 3S Door", nil, "", true, 1,1,1,1, nil, {"Trutle Rock Back Doors", "TR Poke 1 Room 3S Door", "TR Poke 1 Room 3S Door"})
...
TR_square_travel_room_4E_door:connect_two_ways_entrance("", TR_torch_puzzle_deadend_3E_door)
...
TR_small_t_hallway:connect_two_ways(TR_small_t_hallway_3E_door)
TR_small_t_hallway:connect_two_ways(TR_big_chest_ledge)

TR_small_t_hallway_3E_door:connect_two_ways_entrance("", TR_laser_entrance_room_4E_door)
