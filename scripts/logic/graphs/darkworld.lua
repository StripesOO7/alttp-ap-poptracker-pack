...
Dark_flute_spot_1:connect_one_way(Dark_death_mountain_left_bottom_flute_target)
Dark_flute_spot_2:connect_one_way(Dark_potion_shop_area_flute_target)
Dark_flute_spot_3:connect_one_way(Village_of_the_outcast_flute_target)
Dark_flute_spot_4:connect_one_way(Big_bomb_shop_area_flute_target)
Dark_flute_spot_5:connect_one_way(PoD_area_flute_target)
Dark_flute_spot_6:connect_one_way(Mire_ledge_flute_target)
Dark_flute_spot_7:connect_one_way(Swamp_area_flute_target)
Dark_flute_spot_8:connect_one_way(Dark_icerod_area_flute_target)


Skull_woods_area_flute_target:connect_one_way(Skull_woods_area)
Dark_lumpberjacks_flute_target:connect_one_way(Dark_lumpberjacks)
Dark_death_mountain_left_bottom_flute_target:connect_one_way(Dark_death_mountain_left_bottom)
Dark_death_mountain_right_bottom_flute_target:connect_one_way(Dark_death_mountain_right_bottom)
Dark_death_mountain_right_top_flute_target:connect_one_way(Dark_death_mountain_right_top)
Dark_lumpberjacks_flute_target:connect_one_way(Dark_lumpberjacks)
Catfish_area_flute_target:connect_one_way(Catfish_area)
Skull_woods_area_flute_target:connect_one_way(Skull_woods_area)
Village_of_the_outcast_flute_target:connect_one_way(Village_of_the_outcast)
Dark_chapel_area_flute_target:connect_one_way(Dark_chapel_area)
Dark_chapel_area_flute_target:connect_one_way(Dark_chapel_area)
Dark_chapel_area_flute_target:connect_one_way(Dark_chapel_area)
Dark_chapel_area_flute_target:connect_one_way(Dark_chapel_area)
Dark_potion_shop_area_flute_target:connect_one_way(Dark_potion_shop_area)
Catfish_area_flute_target:connect_one_way(Catfish_area)
Village_of_the_outcast_flute_target:connect_one_way(Village_of_the_outcast)
Dark_chapel_area_flute_target:connect_one_way(Dark_chapel_area)
Pyramid_area_flute_target:connect_one_way(Pyramid_area)
PoD_area_flute_target:connect_one_way(PoD_area)
PoD_area_flute_target:connect_one_way(PoD_area)
Hammer_peg_field_flute_target:connect_one_way(Hammer_peg_field)
PoD_area_flute_target:connect_one_way(PoD_area)
South_of_Village_of_the_outcast_flute_target:connect_one_way(South_of_Village_of_the_outcast)
Village_of_the_outcast_flute_target:connect_one_way(Village_of_the_outcast)
Stumpy_flute_target:connect_one_way(Stumpy)
Big_bomb_shop_area_flute_target:connect_one_way(Big_bomb_shop_area)
Big_bomb_shop_area_flute_target:connect_one_way(Big_bomb_shop_area)
Big_bomb_shop_area_flute_target:connect_one_way(Big_bomb_shop_area)
PoD_area_flute_target:connect_one_way(PoD_area)
PoD_area_flute_target:connect_one_way(PoD_area)
Mire_ledge_flute_target:connect_one_way(Mire_ledge)
Big_bomb_shop_area_flute_target:connect_one_way(Big_bomb_shop_area)
