...
Dark_flute_map:connect_one_way(Dark_flute_spot_3)
Dark_flute_map:connect_one_way(Dark_flute_spot_4)
Dark_flute_map:connect_one_way(Dark_flute_spot_5)
Dark_flute_map:connect_one_way(Dark_flute_spot_6)
Dark_flute_map:connect_one_way(Dark_flute_spot_7)
Dark_flute_map:connect_one_way(Dark_flute_spot_8)

-- Dark_flute_spot_1:connect_one_way(Dark_flute_destination_3)
-- Dark_flute_spot_2:connect_one_way(Dark_flute_destination_22)
-- Dark_flute_spot_3:connect_one_way(Dark_flute_destination_24)
-- Dark_flute_spot_4:connect_one_way(Dark_flute_destination_44)
-- Dark_flute_spot_5:connect_one_way(Dark_flute_destination_47)
-- Dark_flute_spot_6:connect_one_way(Dark_flute_destination_48)
-- Dark_flute_spot_7:connect_one_way(Dark_flute_destination_59)
-- Dark_flute_spot_8:connect_one_way(Dark_flute_destination_63)


Dark_flute_destination_0:connect_one_way(Skull_woods_area)
Dark_flute_destination_2:connect_one_way(Dark_lumpberjacks)
Dark_flute_destination_3:connect_one_way(Dark_death_mountain_left_bottom)
Dark_flute_destination_5:connect_one_way(Dark_death_mountain_right_bottom)
Dark_flute_destination_7:connect_one_way(Dark_death_mountain_right_top)
Dark_flute_destination_10:connect_one_way(Dark_lumpberjacks)
Dark_flute_destination_15:connect_one_way(Catfish_area)
Dark_flute_destination_16:connect_one_way(Skull_woods_area)
Dark_flute_destination_17:connect_one_way(Village_of_the_outcast)
Dark_flute_destination_18:connect_one_way(Dark_chapel_area)
Dark_flute_destination_19:connect_one_way(Dark_chapel_area)
Dark_flute_destination_20:connect_one_way(Dark_chapel_area)
Dark_flute_destination_21:connect_one_way(Dark_chapel_area)
Dark_flute_destination_22:connect_one_way(Dark_potion_shop_area)
Dark_flute_destination_23:connect_one_way(Catfish_area)
Dark_flute_destination_24:connect_one_way(Village_of_the_outcast)
Dark_flute_destination_26:connect_one_way(Dark_chapel_area)
Dark_flute_destination_27:connect_one_way(Pyramid_area)
Dark_flute_destination_29:connect_one_way(PoD_area)
Dark_flute_destination_30:connect_one_way(PoD_area)
Dark_flute_destination_34:connect_one_way(Hammer_peg_field)
Dark_flute_destination_37:connect_one_way(PoD_area)
Dark_flute_destination_40:connect_one_way(South_of_Village_of_the_outcast)
Dark_flute_destination_41:connect_one_way(Village_of_the_outcast)
Dark_flute_destination_42:connect_one_way(Stumpy)
Dark_flute_destination_43:connect_one_way(Big_bomb_shop_area)
Dark_flute_destination_44:connect_one_way(Big_bomb_shop_area)
Dark_flute_destination_45:connect_one_way(Big_bomb_shop_area)
Dark_flute_destination_46:connect_one_way(PoD_area)
Dark_flute_destination_47:connect_one_way(PoD_area)
Dark_flute_destination_48:connect_one_way(Mire_ledge)
Dark_flute_destination_50:connect_one_way(Big_bomb_shop_area)
Dark_flute_destination_51:connect_one_way(Swamp_area)
Dark_flute_destination_52:connect_one_way(Swamp_area)
Dark_flute_destination_53:connect_one_way(Swamp_area)
Dark_flute_destination_54:connect_one_way(Dark_icerod_area)
Dark_flute_destination_58:connect_one_way(Swamp_area)
Dark_flute_destination_59:connect_one_way(Swamp_area)
Dark_flute_destination_60:connect_one_way(Swamp_area)
Dark_flute_destination_63:connect_one_way(Dark_icerod_area)
...
Big_bomb_shop_inside:connect_one_way("Buy Big Bomb", function() 
    return ALL(
        ANY(
            Has("crystal56", 2, 2, 2, 2),
            Has("crystal", 7, 7, 7, 7)
        ),
        CanInteract(Big_bomb_shop_inside)
    )
end)
