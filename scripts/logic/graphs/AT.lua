...
AT_first_chest_2N_door = alttp_location.new("AT_first_chest_2N_door", "AT First Chest 2N Door", nil, "", true, 1,1,1,1, nil, {"Agahnim's Tower Doors", "AT First Chest 2N Door", "AT First Chest 2N Door"})
AT_dark_maze_2N_door = alttp_location.new("AT_dark_maze_2N_door", "AT Dark Maze 2N Door", nil, "", true, 1,1,1,1, nil, {"Agahnim's Tower Doors", "AT dark maze 2N door", "AT dark maze 2N door"})
AT_dark_chargers_4N_door = alttp_location.new("AT_dark_chargers_4N_door", "AT dark chargers 4N Door", nil, "", true, 1,1,1,1, nil, {"Agahnim's Tower Doors", "AT dark chargers 4N Door", "AT dark chargers 4N Door"})
AT_dual_statues_4N_door = alttp_location.new("AT_dual_statues_4N_door", "AT Dual Statues 4N Door", nil, "", true, 1,1,1,1, nil, {"Agahnim's Tower Doors", "AT Dual Statues 4N Door", "AT Dual Statues 4N Door"})
AT_dark_archers_2N_door = alttp_location.new("AT_dark_archers_2N_door", "AT Dark Archers 2N Door", nil, "", true, 1,1,1,1, nil, {"Agahnim's Tower Doors", "AT Dark Archers 2N Door", "AT Dark Archers 2N Door"})
AT_red_spears_2N_door = alttp_location.new("AT_red_spears_2N_door", "AT Red Spears 2N door", nil, "", true, 1,1,1,1, nil, {"Agahnim's Tower Doors", "AT Red Spears 2N door", "AT Red Spears 2N door"})
AT_pacifist_run_4N_door = alttp_location.new("AT_pacifist_run_4N_door", "AT Pacifist run 4N door", nil, "", true, 1,1,1,1, nil, {"Agahnim's Tower Doors", "AT Pacifist run 4N door", "AT Pacifist run 4N door"})
AT_push_statue_down_4N_door = alttp_location.new("AT_push_statue_down_4N_door", "AT Push Statue Down 4N door", nil, "", true, 1,1,1,1, nil, {"Agahnim's Tower Doors", "AT Push Statue Down 4N door", "AT Push Statue Down 4N door"})
AT_catwalk_1N_door = alttp_location.new("AT_catwalk_1N_door", "AT Catwalk 1N Door", nil, "", true, 1,1,1,1, nil, {"Agahnim's Tower Doors", "AT Catwalk 1N Door", "AT Catwalk 1N Door"})
AT_antechamber_2S_door = alttp_location.new("AT_antechamber_2S_door", "AT Antechamber 2S Door", nil, "", true, 1,1,1,1, nil, {"Agahnim's Tower Doors", "AT Antechamber 2S Door", "AT Antechamber 2S Door"})
AT_pre_curtain_1N_door = alttp_location.new("AT_pre_curtain_1N_door", "AT Pre Crtain 1N Door", nil, "", true, 1,1,1,1, nil, {"Agahnim's Tower Doors", "AT Pre Crtain 1N Door", "AT Pre Crtain 1N Door"})
AT_aga_arena_3S_door = alttp_location.new("AT_aga_arena_3S_door", "AT Aga Arena 3S Door", nil, "", true, 1,1,1,1, nil, {"Agahnim's Tower Doors", "AT Aga Arena 3S Door", "AT Aga Arena 3S Door"})
