...
Light_flute_map:connect_one_way(Light_flute_spot_3)
Light_flute_map:connect_one_way(Light_flute_spot_4)
Light_flute_map:connect_one_way(Light_flute_spot_5)
Light_flute_map:connect_one_way(Light_flute_spot_6)
Light_flute_map:connect_one_way(Light_flute_spot_7)
Light_flute_map:connect_one_way(Light_flute_spot_8)

-- Light_flute_spot_1:connect_one_way(Light_flute_destination_3)
-- Light_flute_spot_2:connect_one_way(Light_flute_destination_22)
-- Light_flute_spot_3:connect_one_way(Light_flute_destination_24)
-- Light_flute_spot_4:connect_one_way(Light_flute_destination_44)
-- Light_flute_spot_5:connect_one_way(Light_flute_destination_47)
-- Light_flute_spot_6:connect_one_way(Light_flute_destination_48)
-- Light_flute_spot_7:connect_one_way(Light_flute_destination_59)
-- Light_flute_spot_8:connect_one_way(Light_flute_destination_63)

Light_flute_destination_0:connect_one_way(Lost_woods)
Light_flute_destination_2:connect_one_way(Lumberjacks_area)
Light_flute_destination_3:connect_one_way(Light_death_mountain_left_bottom)
Light_flute_destination_5:connect_one_way(Light_death_mountain_right_bottom)
Light_flute_destination_7:connect_one_way(Light_death_mountain_right_top)
Light_flute_destination_10:connect_one_way(Lumberjacks_area)
Light_flute_destination_15:connect_one_way(Zora_river)
Light_flute_destination_16:connect_one_way(Lost_woods)
Light_flute_destination_17:connect_one_way(Kakariko_village)
Light_flute_destination_18:connect_one_way(Sanctuary_area)
Light_flute_destination_19:connect_one_way(Sanctuary_area)
Light_flute_destination_20:connect_one_way(Sanctuary_area)
Light_flute_destination_21:connect_one_way(Sanctuary_area)
Light_flute_destination_22:connect_one_way(Witchhut)
Light_flute_destination_23:connect_one_way(Zora_river)
Light_flute_destination_24:connect_one_way(Kakariko_village)
Light_flute_destination_26:connect_one_way(Sanctuary_area)
Light_flute_destination_27:connect_one_way(Hyrule_castle_area)
Light_flute_destination_29:connect_one_way(Eastern_palace_area)
Light_flute_destination_30:connect_one_way(Eastern_palace_area)
Light_flute_destination_34:connect_one_way(Kakariko_village)
Light_flute_destination_37:connect_one_way(Eastern_palace_area)
Light_flute_destination_40:connect_one_way(South_of_village)
Light_flute_destination_41:connect_one_way(Kakariko_village)
Light_flute_destination_42:connect_one_way(Links_house_area)
Light_flute_destination_43:connect_one_way(Links_house_area)
Light_flute_destination_44:connect_one_way(Links_house_area)
Light_flute_destination_45:connect_one_way(Links_house_area)
Light_flute_destination_46:connect_one_way(Eastern_palace_area)
Light_flute_destination_47:connect_one_way(Eastern_palace_area)
Light_flute_destination_48:connect_one_way(Teleporter_at_Desert_ledge)
Light_flute_destination_50:connect_one_way(Links_house_area)
Light_flute_destination_51:connect_one_way(Dam_area)
Light_flute_destination_52:connect_one_way(Dam_area)
Light_flute_destination_53:connect_one_way(Light_lake_hylia)
Light_flute_destination_54:connect_one_way(Light_lake_hylia)
Light_flute_destination_58:connect_one_way(Dam_area)
Light_flute_destination_59:connect_one_way(Dam_area)
Light_flute_destination_60:connect_one_way(Dam_area)
Light_flute_destination_63:connect_one_way(Light_lake_hylia)
...
-- Paradox_cave_bottom_back:connect_one_way("Paradox Cave Bottom Bomb Area - Pot #2", function() return CanInteract(Paradox_cave_bottom_back) end)
