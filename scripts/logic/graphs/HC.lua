...
HC_main_hall_N_door = alttp_location.new("HC_main_hall_N_door", "HC Main Hall N Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Main Hall N Door", "HC Main Hall N Door"})
HC_main_hall_1W_door = alttp_location.new("HC_main_hall_1W_door", "HC Main Hall 1W Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Main Hall 1W Door", "HC Main Hall 1W Door"})
HC_main_hall_W_door = alttp_location.new("HC_main_hall_W_door", "HC Main Hall W Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Main Hall W Door", "HC Main Hall W Door"})
HC_main_hall_E_door = alttp_location.new("HC_main_hall_E_door", "HC Main Hall E Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Main Hall E Door", "HC Main Hall E Door"})
HC_left_wing_lobby_2E_door = alttp_location.new("HC_left_wing_lobby_2E_door", "HC Left Wing Lobby 2E Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Left Wing Lobby 2E Door", "HC Left Wing Lobby 2E Door"})
HC_left_wing_lobby_E_door = alttp_location.new("HC_left_wing_lobby_E_door", "HC Left Wing Lobby E Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Left Wing Lobby E Door", "HC Left Wing Lobby E Door"})
HC_left_wing_lobby_2N_door = alttp_location.new("HC_left_wing_lobby_2N_door", "HC Left Wing Lobby 2N Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Left Wing Lobby 2N Door", "HC Left Wing Lobby 2N Door"})
HC_left_wing_4S_door = alttp_location.new("HC_left_wing_4S_door", "HC Left Wing 4S Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Left Wing 4S Door", "HC Left Wing 4S Door"})
HC_left_wing_2E_door = alttp_location.new("HC_left_wing_2E_door", "HC Left Wing 2E Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Left Wing 2E Door", "HC Left Wing 2E Door"})
HC_right_wing_lobby_3W_door = alttp_location.new("HC_right_wing_lobby_3W_door", "HC Right Wing Lobby 3W Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Right Wing Lobby 3W Door", "HC Right Wing Lobby 3W Door"})
HC_right_wing_lobby_1N_door = alttp_location.new("HC_right_wing_lobby_1N_door", "HC Right Wing Lobby 1N Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Right Wing Lobby 1N Door", "HC Right Wing Lobby 1N Door"})
HC_right_wing_lobby_N_door = alttp_location.new("HC_right_wing_lobby_N_door", "HC Right Wing Lobby N Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Right Wing Lobby N Door", "HC Right Wing Lobby N Door"})
HC_right_wing_3S_door = alttp_location.new("HC_right_wing_3S_door", "HC Right Wing 3S Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Right Wing 3S Door", "HC Right Wing 3S Door"})
HC_right_wing_S_door = alttp_location.new("HC_right_wing_S_door", "HC Right Wing S Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Right Wing S Door", "HC Right Wing S Door"})
HC_right_wing_1W_door = alttp_location.new("HC_right_wing_1W_door", "HC Right Wing 1W Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Right Wing 1W Door", "HC Right Wing 1W Door"})
HC_throne_room_S_door = alttp_location.new("HC_throne_room_S_door", "HC Throne Room S Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Throne Room S Door", "HC Throne Room S Door"})
HC_throne_room_N_door = alttp_location.new("HC_throne_room_N_door", "HC Throne Room N Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Throne Room N Door", "HC Throne Room N Door"})
HC_back_wing_2E_door = alttp_location.new("HC_back_wing_2E_door", "HC Back Wing 2E Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Back Wing 2E Door", "HC Back Wing 2E Door"})
HC_back_wing_1W_door = alttp_location.new("HC_back_wing_1W_door", "HC Back Wing 1W Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Back Wing 1W Door", "HC Back Wing 1W Door"})
HC_back_wing_N_door = alttp_location.new("HC_back_wing_N_door", "HC Back Wing N Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Back Wing N Door", "HC Back Wing N Door"})
HC_map_chest_room_N_door = alttp_location.new("HC_map_chest_room_N_door", "HC_map Chest Room N Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC_map Chest Room N Door", "HC_map Chest Room N Door"})
HC_north_abyss_S_door = alttp_location.new("HC_north_abyss_S_door", "HC North Abyss S Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC North Abyss S Door", "HC North Abyss S Door"})
HC_north_abyss_balcony_3S_door = alttp_location.new("HC_north_abyss_balcony_3S_door", "HC North Abyss Balcony 3S Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC North Abyss Balcony 3S Door", "HC North Abyss Balcony 3S Door"})
HC_abyss_balcony_1N_door = alttp_location.new("HC_abyss_balcony_1N_door", "HC Abyss Balcony 1N Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Abyss Balcony 1N Door", "HC Abyss Balcony 1N Door"})
HC_abyss_balcony_1W_door = alttp_location.new("HC_abyss_balcony_1W_door", "HC Abyss Balcony 1W Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Abyss Balcony 1W Door", "HC Abyss Balcony 1W Door"})
HC_abyss_catwalk_N_door = alttp_location.new("HC_abyss_catwalk_N_door", "HC Abyss Catwalk N Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Abyss Catwalk N Door", "HC Abyss Catwalk N Door"})
HC_abyss_catwalk_3W_door = alttp_location.new("HC_abyss_catwalk_3W_door", "HC Abyss Catwalk 3W Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Abyss Catwalk 3W Door", "HC Abyss Catwalk 3W Door"})
HC_armory_2E_door = alttp_location.new("HC_armory_2E_door", "HC Armory 2E Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Armory 2E Door", "HC Armory 2E Door"})
HC_armory_4E_door = alttp_location.new("HC_armory_4E_door", "HC Armory 4E Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Armory 4E Door", "HC Armory 4E Door"})
HC_armory_1N_door = alttp_location.new("HC_armory_1N_door", "HC Armory 1N Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Armory 1N Door", "HC Armory 1N Door"})
HC_before_boomerang_chest_room_3S_door = alttp_location.new("HC_before_boomerang_chest_room_3S_door", "HC Before Boomerang Chest Room 3S Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Before Boomerang Chest Room 3S Door", "HC Before Boomerang Chest Room 3S Door"})
HC_cell_hallway_1N_door = alttp_location.new("HC_cell_hallway_1N_door", "HC Cell Hallway 1N Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Cell Hallway 1N Door", "HC Cell Hallway 1N Door"})
HC_ball_guard_room_1N_door = alttp_location.new("HC_ball_guard_room_1N_door", "HC Ball Guard Room 1N Door", nil, "", true, 1,1,1,1, nil, {"Hyrule Castle Doors", "HC Ball Guard Room 1N Door", "HC Ball Guard Room 1N Door"})
...
CE_tapestry_S_door = alttp_location.new("CE_tapestry_S_door", "CE Tapestry S Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Tapestry S Door", "CE Tapestry S Door"})
CE_tapestry_N_door = alttp_location.new("CE_tapestry_N_door", "CE Tapestry N Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Tapestry N Door", "CE Tapestry N Door"})
CE_snake_hall_1N_door = alttp_location.new("CE_snake_hall_1N_door", "CE Snake Hall 1N Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Snake Hall 1N Door", "CE Snake Hall 1N Door"})
CE_snake_hall_2N_door = alttp_location.new("CE_snake_hall_2N_door", "CE Snake Hall 2N Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Snake Hall 2N Door", "CE Snake Hall 2N Door"})
CE_dark_cross_N_door = alttp_location.new("CE_dark_cross_N_door", "CE Dark Cross N Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Dark Cross N Door", "CE Dark Cross N Door"})
CE_dark_cross_S_door = alttp_location.new("CE_dark_cross_S_door", "CE Dark Cross S Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Dark Cross S Door", "CE Dark Cross S Door"})
CE_small_sewers_S_door = alttp_location.new("CE_small_sewers_S_door", "CE Small Sewers S Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Small Sewers S Door", "CE Small Sewers S Door"})
CE_small_sewers_W_door = alttp_location.new("CE_small_sewers_W_door", "CE Small Sewers W Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Small Sewers W Door", "CE Small Sewers W Door"})
CE_large_sewers_E_door = alttp_location.new("CE_large_sewers_E_door", "CE Large Sewers E Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Large Sewers E Door", "CE Large Sewers E Door"})
-- CE_large_sewers_N_door = alttp_location.new("CE_large_sewers_N_door", "CE Large Sewers N Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Large Sewers N Door", "CE Large Sewers N Door"})
CE_rat_key_room_N_door = alttp_location.new("CE_rat_key_room_N_door", "CE Rat Key Room N Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Rat Key Room N Door", "CE Rat Key Room N Door"})
CE_dropdown_room_S_door = alttp_location.new("CE_dropdown_room_S_door", "CE Dropdown Room S Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Dropdown Room S Door", "CE Dropdown Room S Door"})
CE_dropdown_room_N_door = alttp_location.new("CE_dropdown_room_N_door", "CE Dropdown Room N Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Dropdown Room N Door", "CE Dropdown Room N Door"})
CE_pulley_S_door = alttp_location.new("CE_pulley_S_door", "CE Pulley S Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Pulley S Door", "CE Pulley S Door"})
CE_yet_more_rats_N_door = alttp_location.new("CE_yet_more_rats_N_door", "CE Yet More Rats N Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Yet More Rats N Door", "CE Yet More Rats N Door"})
CE_stairs_1N_door = alttp_location.new("CE_stairs_1N_door", "CE Stairs 1N Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Stairs 1N Door", "CE Stairs 1N Door"})

CE_stairs_N_door = alttp_location.new("CE_stairs_N_door", "CE Stairs N Door", nil, "", true, 1,1,1,1, nil, {"Castle Escape Doors", "CE Stairs N Door", "CE Stairs N Door"})
-- local HC_
Sanctuary_secret_door = alttp_location.new("Sanctuary_secret_door", "Sanctuary Secret Door", nil, "", true, 1,1,1,1, nil, {"Sanctuary Doors", "Sanctuary Secret Door", "Sanctuary Secret Door"})
