...
CE_secret_room:connect_one_way("CE - Secret Room Pot #1")
-- CE_secret_room:connect_one_way("CE - Secret Room Pot #2")
-- CE_secret_room:connect_one_way("CE - Secret Room Pot #3")
-- CE_secret_room:connect_one_way("CE - Secret Room Pot #4")
-- CE_secret_room:connect_one_way("CE - Secret Room Pot #5")
-- CE_secret_room:connect_one_way("CE - Secret Room Pot #6")

CE_secret_room:connect_one_way(CE_dropdown_room_N_door)
CE_dropdown_room_N_door:connect_two_ways_entrance("", CE_yet_more_rats)

CE_yet_more_rats:connect_one_way("CE - Yet More Rats Pot #1")
