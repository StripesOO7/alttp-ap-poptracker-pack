...
SW_compass_room_2N_door = alttp_location.new("SW_compass_room_2N_door", "SW Compass Room 2N Door", nil, "", true, 1,1,1,1, nil, {"Skull Woods Front Doors", "SW Compass Room 2N Door", "SW Compass Room 2N Door"})
SW_compass_room_4E_door = alttp_location.new("SW_compass_room_4E_door", "SW Compass Room 4E Door", nil, "", true, 1,1,1,1, nil, {"Skull Woods Front Doors", "SW Compass Room 4E Door", "SW Compass Room 4E Door"})
SW_pot_prison_4E_door = alttp_location.new("SW_pot_prison_4E_door", "SW Pot Prison 4E Door", nil, "", true, 1,1,1,1, nil, {"Skull Woods Front Doors", "SW Pot Prison 4E Door", "SW Pot Prison 4E Door"})
SW_pot_prison_4S_door = alttp_location.new("SW_pot_prison_4S_door", "SW Pot Prison 4S Door", nil, "", true, 1,1,1,1, nil, {"Skull Woods Front Doors", "SW Pot Prison 4S Door", "SW Pot Prison 4S Door"})
SW_pinball_room_3W_door = alttp_location.new("SW_pinball_room_3W_door", "SW Pinball Room 3W Door", nil, "", true, 1,1,1,1, nil, {"Skull Woods Front Doors", "SW Pinball Room 3W Door", "SW Pinball Room 3W Door"})
SW_pinball_room_2N_door = alttp_location.new("SW_pinball_room_2N_door", "SW Pinball Room 2N Door", nil, "", true, 1,1,1,1, nil, {"Skull Woods Front Doors", "SW Pinball Room 2N Door", "SW Pinball Room 2N Door"})
SW_map_room_4S_door = alttp_location.new("SW_map_room_4S_door", "SW Map Room 4S Door", nil, "", true, 1,1,1,1, nil, {"Skull Woods Front Doors", "SW Map Room 4S Door", "SW Map Room 4S Door"})
SW_big_chest_entrance_3W_door = alttp_location.new("SW_big_chest_entrance_3W_door", "SW Big Chest Entrance 3W Door", nil, "", true, 1,1,1,1, nil, {"Skull Woods Front Doors", "SW Big Chest Entrance 3W Door", "SW Big Chest Entrance 3W Door"})
SW_gibdo_entrance_3W_door = alttp_location.new("SW_gibdo_entrance_3W_door", "SW Gibdo Entrance 3W Door", nil, "", true, 1,1,1,1, nil, {"Skull Woods Front Doors", "SW Gibdo Entrance 3W Door", "SW Gibdo Entrance 3W Door"})
SW_gibdo_west_lobby_connector_4E_door = alttp_location.new("SW_gibdo_west_lobby_connector_4E_door", "SW Gibdo West Lobby Connector 4E Door", nil, "", true, 1,1,1,1, nil, {"Skull Woods Front Doors", "SW Gibdo West Lobby Connector 4E Door", "SW Gibdo West Lobby Connector 4E Door"})
SW_back_bridge_1N_door = alttp_location.new("SW_back_bridge_1N_door", "SW Back Bridge 1N Door", nil, "", true, 1,1,1,1, nil, {"Skull Woods Back Doors", "SW Back Bridge 1N Door", "SW Back Bridge 1N Door"})
SW_star_switch_holes_3S_door = alttp_location.new("SW_star_switch_holes_3S_door", "SW Star Switch Holes 3S Door", nil, "", true, 1,1,1,1, nil, {"Skull Woods Back Doors", "SW Star Switch Holes 3S Door", "SW Star Switch Holes 3S Door"})
SW_vines_room_1N_door = alttp_location.new("SW_vines_room_1N_door", "SW Vines Room 1N Door", nil, "", true, 1,1,1,1, nil, {"Skull Woods Back Doors", "SW Vines Room 1N Door", "SW Vines Room 1N Door"})
SW_back_spike_corner_room_3S_door = alttp_location.new("SW_back_spike_corner_room_3S_door", "SW Back Spike Corner Room 3S Door", nil, "", true, 1,1,1,1, nil, {"Skull Woods Back Doors", "SW Back Spike Corner Room 3S Door", "SW Back Spike Corner Room 3S Door"})
