...
MM_big_key_door_room_bridge_NS_2N_door = alttp_location.new("MM_big_key_door_room_bridge_NS_2N_door", "MM Big Key Door Room Bridge NS 2N door")
...
MM_big_key_door_room_bridge_NS:connect_two_ways(MM_big_key_door_room_bridge_NS_2N_door)
MM_big_key_door_room_bridge_NS_2N_door:connect_two_ways_entrance("", MM_bridge_right_4S_door)
