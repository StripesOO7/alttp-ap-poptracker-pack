...
MM_post_gap_4N_door = alttp_location.new("MM_post_gap_4N_door", "MM post gap 4N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM post gap 4N door", "MM post gap 4N door"})
MM_wizrobe_room_4N_door = alttp_location.new("MM_wizrobe_room_4N_door", "MM wizrobe room 4N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM wizrobe room 4N door", "MM wizrobe room 4N door"})
MM_wizrobe_room_2N_door = alttp_location.new("MM_wizrobe_room_2N_door", "MM wizrobe room 2N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM wizrobe room 2N door", "MM wizrobe room 2N door"})
MM_main_room_1N_door = alttp_location.new("MM_main_room_1N_door", "MM main room 1N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM main room 1N door", "MM main room 1N door"})
MM_main_room_1W_door = alttp_location.new("MM_main_room_1W_door", "MM main room 1W door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM main room 1W door", "MM main room 1W door"})
MM_main_room_2N_door = alttp_location.new("MM_main_room_2N_door", "MM main room 2N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM main room 2N door", "MM main room 2N door"})
MM_main_room_2E_door = alttp_location.new("MM_main_room_2E_door", "MM main room 2E door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM main room 2E door", "MM main room 2E door"})
MM_main_room_E_door = alttp_location.new("MM_main_room_E_door", "MM main room E door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM main room E door", "MM main room E door"})
MM_main_room_3W_door = alttp_location.new("MM_main_room_3W_door", "MM main room 3W door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM main room 3W door", "MM main room 3W door"})
MM_main_room_4E_door = alttp_location.new("MM_main_room_4E_door", "MM main room 4E door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM main room 4E door", "MM main room 4E door"})
MM_main_room_4S_door = alttp_location.new("MM_main_room_4S_door", "MM main room 4S door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM main room 4S door", "MM main room 4S door"})
MM_map_room_top_middle_1N_door = alttp_location.new("MM_map_room_top_middle_1N_door", "MM map room top middle 1N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM map room top middle 1N door", "MM map room top middle 1N door"})
MM_map_room_top_left_1W_door = alttp_location.new("MM_map_room_top_left_1W_door", "MM map room top_left 1W door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM map room top_left 1W door", "MM map room top_left 1W door"})
MM_map_room_bottom_3W_door = alttp_location.new("MM_map_room_bottom_3W_door", "MM map room bottom 3W door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM map room bottom 3W door", "MM map room bottom 3W door"})
MM_map_room_center_bridge_W_door = alttp_location.new("MM_map_room_center_bridge_W_door", "MM map room center bridge W door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM map room center bridge W door", "MM map room center bridge W door"})
MM_conveyor_crystal_room_4E_door = alttp_location.new("MM_conveyor_crystal_room_4E_door", "MM conveyor crystal room 4E door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM conveyor crystal room 4E door", "MM conveyor crystal room 4E door"})
MM_conveyor_crystal_room_4S_door = alttp_location.new("MM_conveyor_crystal_room_4S_door", "MM conveyor crystal room 4S door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM conveyor crystal room 4S door", "MM conveyor crystal room 4S door"})
MM_neglected_room_2N_door = alttp_location.new("MM_neglected_room_2N_door", "MM neglected room 2N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM neglected room 2N door", "MM neglected room 2N door"})
MM_four_torches_tile_room_3S_door = alttp_location.new("MM_four_torches_tile_room_3S_door", "MM four torches tile room 3S door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM four torches tile room 3S door", "MM four torches tile room 3S door"})
MM_bomb_slug_room_3S_door = alttp_location.new("MM_bomb_slug_room_3S_door", "MM bomb slug room 3S door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM bomb slug room 3S door", "MM bomb slug room 3S door"})
MM_spike_room_3W_door = alttp_location.new("MM_spike_room_3W_door", "MM spike room 3W door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM spike room 3W door", "MM spike room 3W door"})
MM_spike_room_3S_door = alttp_location.new("MM_spike_room_3S_door", "MM spike room 3S door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM spike room 3S door", "MM spike room 3S door"})
MM_2_torches_hidden_shooter_4E_door = alttp_location.new("MM_2_torches_hidden_shooter_4E_door", "MM 2 torches hidden shooter 4E door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM 2 torches hidden shooter 4E door", "MM 2 torches hidden shooter 4E door"})
MM_2_torches_hidden_shooter_4S_door = alttp_location.new("MM_2_torches_hidden_shooter_4S_door", "MM 2 torches hidden shooter 4S door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM 2 torches hidden shooter 4S door", "MM 2 torches hidden shooter 4S door"})
MM_big_keydoor_room_bridge_NS_2N_door = alttp_location.new("MM_big_keydoor_room_bridge_NS_2N_door", "MM Big Key Door Room Bridge NS 2N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM Big Key Door Room Bridge NS 2N door", "MM Big Key Door Room Bridge NS 2N door"})
MM_above_spike_room_1N_door = alttp_location.new("MM_above_spike_room_1N_door", "MM above spike room 1N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM above spike room 1N door", "MM above spike room 1N door"})
MM_above_spike_room_1W_door = alttp_location.new("MM_above_spike_room_1W_door", "MM above spike room 1W door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM above spike room 1W door", "MM above spike room 1W door"})
MM_big_keydoor_room_N_door = alttp_location.new("MM_big_keydoor_room_N_door", "MM big key door room N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM big key door room N door", "MM big key door room N door"})
MM_big_keydoor_room_2E_door = alttp_location.new("MM_big_keydoor_room_2E_door", "MM big key door room 2E door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM big key door room 2E door", "MM big key door room 2E door"})
MM_bridge_right_4S_door = alttp_location.new("MM_bridge_right_4S_door", "MM bridge right 4S door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM bridge right 4S door", "MM bridge right 4S door"})
MM_bridge_middle_N_door = alttp_location.new("MM_bridge_middle_N_door", "MM bridge_middle N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM bridge_middle N door", "MM bridge_middle N door"})
MM_bridge_middle_S_door = alttp_location.new("MM_bridge_middle_S_door", "MM bridge middle S door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM bridge middle S door", "MM bridge middle S door"})
MM_bridge_EW_E_door = alttp_location.new("MM_bridge_EW_E_door", "MM bridge EW E door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM bridge EW E door", "MM bridge EW E door"})
MM_bridge_EW_W_door = alttp_location.new("MM_bridge_EW_W_door", "MM bridge EW W door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM bridge EW W door", "MM bridge EW W door"})
MM_bent_bridge_W_door = alttp_location.new("MM_bent_bridge_W_door", "MM bent bridge W door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM bent bridge W door", "MM bent bridge W door"})
MM_bent_bridge_3S_door = alttp_location.new("MM_bent_bridge_3S_door", "MM bent bridge 3S door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM bent bridge 3S door", "MM bent bridge 3S door"})
MM_fishbone_room_E_door = alttp_location.new("MM_fishbone_room_E_door", "MM fishbone room E door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM fishbone room E door", "MM fishbone room E door"})
MM_fishbone_room_4S_door = alttp_location.new("MM_fishbone_room_4S_door", "MM fishbone room 4S door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM fishbone room 4S door", "MM fishbone room 4S door"})
MM_hourglas_room_2N_door = alttp_location.new("MM_hourglas_room_2N_door", "MM hourglas room 2N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM hourglas room 2N door", "MM hourglas room 2N door"})
MM_hourglas_room_4S_door = alttp_location.new("MM_hourglas_room_4S_door", "MM hourglas room 4S door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM hourglas room 4S door", "MM hourglas room 4S door"})
MM_wizzrobe_bypass_2E_door = alttp_location.new("MM_wizzrobe_bypass_2E_door", "MM wizzrobe bypass 2E door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM wizzrobe bypass 2E door", "MM wizzrobe bypass 2E door"})
MM_wizzrobe_bypass_2N_door = alttp_location.new("MM_wizzrobe_bypass_2N_door", "MM wizzrobe bypass 2N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM wizzrobe bypass 2N door", "MM wizzrobe bypass 2N door"})
MM_conveyor_bomb_slug_room_N_door = alttp_location.new("MM_conveyor_bomb_slug_room_N_door", "MM conveyor bomb slug room N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM conveyor bomb slug room N door", "MM conveyor bomb slug room N door"})
MM_conveyor_bomb_slug_room_1N_door = alttp_location.new("MM_conveyor_bomb_slug_room_1N_door", "MM conveyor bomb slug room 1N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM conveyor bomb slug room 1N door", "MM conveyor bomb slug room 1N door"})
MM_torches_top_N_door = alttp_location.new("MM_torches_top_N_door", "MM torches top N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM torches top N door", "MM torches top N door"})
MM_dark_shooters_N_door = alttp_location.new("MM_dark_shooters_N_door", "MM dark_ hooters N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM dark_ hooters N door", "MM dark_ hooters N door"})
MM_block_X_3W_door = alttp_location.new("MM_block_X_3W_door", "MM block X 3W door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM block X 3W door", "MM block X 3W door"})
MM_tall_dark_and_roomy_4E_door = alttp_location.new("MM_tall_dark_and_roomy_4E_door", "MM tall dark and roomy 4E door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM tall dark and roomy 4E door", "MM tall dark and roomy 4E door"})
MM_crystal_left_3W_door = alttp_location.new("MM_crystal_left_3W_door", "MM crystal left 3W door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM crystal left 3W door", "MM crystal left 3W door"})
MM_falling_foes_4E_door = alttp_location.new("MM_falling_foes_4E_door", "MM falling foes 4E door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM falling foes 4E door", "MM falling foes 4E door"})
MM_falling_foes_2N_door = alttp_location.new("MM_falling_foes_2N_door", "MM falling foes 2N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM falling foes 2N door", "MM falling foes 2N door"})
MM_antechamber_left_1N_door = alttp_location.new("MM_antechamber_left_1N_door", "MM antechamber left 1N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM antechamber left 1N door", "MM antechamber left 1N door"})
MM_antechamber_right_2N_door = alttp_location.new("MM_antechamber_right_2N_door", "MM antechamber right 2N door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM antechamber right 2N door", "MM antechamber right 2N door"})
MM_boss_room_3S_door = alttp_location.new("MM_boss_room_3S_door", "MM boss room 3S door", nil, "", true, 1,1,1,1, nil, {"Misery Mire Doors", "MM boss room 3S door", "MM boss room 3S door"})
