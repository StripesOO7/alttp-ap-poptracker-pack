...
MM_big_keydoor_room_bridge_NS_2N_door = alttp_location.new("MM_big_keydoor_room_bridge_NS_2N_door", "MM Big Key Door Room Bridge NS 2N door")
...
MM_big_keydoor_room_N_door = alttp_location.new("MM_big_keydoor_room_N_door", "MM big key door room N door")
MM_big_keydoor_room_2E_door = alttp_location.new("MM_big_keydoor_room_2E_door", "MM big key door room 2E door")
...
MM_falling_foes_2N_door = alttp_location.new("MM_falling_foes_2N_door", "MM falling foes 2N door")
