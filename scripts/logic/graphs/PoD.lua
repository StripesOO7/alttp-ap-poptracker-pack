...
local PoD_collapsing_bridge_front = alttp_location.new("PoD_collapsing_bridge_front", "PoD Collapsing Bridge Front", nil, "PoD", true)
local PoD_collapsing_bridge_back = alttp_location.new("PoD_collapsing_bridge_back", "PoD Collapsing Bridge Back", nil, "PoD", true)
...
local PoD_dark_U_basement = alttp_location.new("PoD_dark_U_basement", "PoD Dark U Basement", nil, "PoD", true)
local PoD_dark_inner_basement = alttp_location.new("PoD_dark_inner_basement", "PoD Dark Inner Basement", nil, "PoD", true)
...
local PoD_lobby = alttp_location.new("PoD_lobby", "PoD_lobby")
local PoD_bari_hallway = alttp_location.new("PoD_bari_hallway", "PoD_bari_hallway")
local PoD_teleporter_room_B_side = alttp_location.new("PoD_teleporter_room_B_side", "PoD_teleporter_room_B_side")
local PoD_arena_ledge = alttp_location.new("PoD_arena_ledge", "PoD_arena_ledge")
local PoD_conveyor_hallway = alttp_location.new("PoD_conveyor_hallway", "PoD_conveyor_hallway")
local PoD_arena_left_bridge = alttp_location.new("PoD_arena_left_bridge", "PoD_arena_left_bridge")
local PoD_arena_right_bridge = alttp_location.new("PoD_arena_right_bridge", "PoD_arena_right_bridge")
local PoD_arena_back_bridge = alttp_location.new("PoD_arena_back_bridge", "PoD_arena_back_bridge")
local PoD_arena_center = alttp_location.new("PoD_arena_center", "PoD_arena_center")
local PoD_arena_right = alttp_location.new("PoD_arena_right", "PoD_arena_right")
local PoD_mimics_2 = alttp_location.new("PoD_mimics_2", "PoD_mimics_2")
local PoD_bow_statue = alttp_location.new("PoD_bow_statue", "PoD_bow_statue")
local PoD_dark_pegs = alttp_location.new("PoD_dark_pegs", "PoD_dark_pegs")
local PoD_lonely_turtle = alttp_location.new("PoD_lonely_turtle", "PoD_lonely_turtle")
...
PoD_three_way_room_left_1N_door = alttp_location.new("PoD_three_way_room_left_1N_door", "PoD Three Way Room Left 1N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Three Way Room Left 1N Door", "PoD Three Way Room Left 1N Door"})
PoD_three_way_room_middle_N_door = alttp_location.new("PoD_three_way_room_middle_N_door", "PoD Three Way Room Middle N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Three Way Room Middle N Door", "PoD Three Way Room Middle N Door"})
PoD_three_way_room_right_2N_door = alttp_location.new("PoD_three_way_room_right_2N_door", "PoD Three Way Room Right 2N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Three Way Room Right 2N Door", "PoD Three Way Room Right 2N Door"})
PoD_big_key_chest_room_S_door = alttp_location.new("PoD_big_key_chest_room_S_door", "PoD Big Key Chest Room S Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Big Key Chest Room S Door", "PoD Big Key Chest Room S Door"})
PoD_big_key_chest_room_1N_door = alttp_location.new("PoD_big_key_chest_room_1N_door", "PoD Big Key Chest Room 1N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Big Key Chest Room 1N Door", "PoD Big Key Chest Room 1N Door"})
PoD_big_key_chest_room_N_door = alttp_location.new("PoD_big_key_chest_room_N_door", "PoD Big Key Chest Room N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Big Key Chest Room N Door", "PoD Big Key Chest Room N Door"})
PoD_big_key_chest_room_2N_door = alttp_location.new("PoD_big_key_chest_room_2N_door", "PoD Big Key Chest Room 2N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Big Key Chest Room 2N Door", "PoD Big Key Chest Room 2N Door"})
PoD_shooter_room_1N_door = alttp_location.new("PoD_shooter_room_1N_door", "PoD Shooter Room 1N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Shooter Room 1N Door", "PoD Shooter Room 1N Door"})
PoD_teleporter_room_2N_door = alttp_location.new("PoD_teleporter_room_2N_door", "PoD Teleporter Room 2N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Teleporter Room 2N Door", "PoD Teleporter Room 2N Door"})
PoD_mimic_room_1N_door = alttp_location.new("PoD_mimic_room_1N_door", "PoD Mimic Room 1N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Mimic Room 1N Door", "PoD Mimic Room 1N Door"})
PoD_conveyor_hallway_1N_door = alttp_location.new("PoD_conveyor_hallway_1N_door", "PoD Conveyor Hallway 1N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Conveyor Hallway 1N Door", "PoD Conveyor Hallway 1N Door"})
PoD_conveyor_hallway_3S_door = alttp_location.new("PoD_conveyor_hallway_3S_door", "PoD Conveyor Hallway 3S Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Conveyor Hallway 3S Door", "PoD Conveyor Hallway 3S Door"})
PoD_switch_room_top_3S_door = alttp_location.new("PoD_switch_room_top_3S_door", "PoD Switch Room Top 3S Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Switch Room Top 3S Door", "PoD Switch Room Top 3S Door"})
PoD_switch_room_top_3W_door = alttp_location.new("PoD_switch_room_top_3W_door", "PoD Switch Room Top 3W Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Switch Room Top 3W Door", "PoD Switch Room Top 3W Door"})
PoD_switch_room_bottom_N_door = alttp_location.new("PoD_switch_room_bottom_N_door", "PoD Switch Room Bottom N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Switch Room Bottom N Door", "PoD Switch Room Bottom N Door"})
PoD_switch_room_bottom_W_door = alttp_location.new("PoD_switch_room_bottom_W_door", "PoD Switch Room Bottom W Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Switch Room Bottom W Door", "PoD Switch Room Bottom W Door"})
PoD_basement_ledge_N_door = alttp_location.new("PoD_basement_ledge_N_door", "PoD Basement Ledge N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Basement Ledge N Door", "PoD Basement Ledge N Door"})
PoD_arena_right_E_door = alttp_location.new("PoD_arena_right_E_door", "PoD Arena Right E Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Arena Right E Door", "PoD Arena Right E Door"})
PoD_arena_left_bridge_3S_door = alttp_location.new("PoD_arena_left_bridge_3S_door", "PoD Arena Left Bridge 3S Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Arena Left Bridge 3S Door", "PoD Arena Left Bridge 3S Door"})
PoD_arena_right_bridge_4S_door = alttp_location.new("PoD_arena_right_bridge_4S_door", "PoD Arena Right Bridge 4S Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Arena Right Bridge 4S Door", "PoD Arena Right Bridge 4S Door"})
PoD_arena_back_bridge_1N_door = alttp_location.new("PoD_arena_back_bridge_1N_door", "PoD Arena Back Bridge 1N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Arena Back Bridge 1N Door", "PoD Arena Back Bridge 1N Door"})
PoD_arena_back_bridge_2N_door = alttp_location.new("PoD_arena_back_bridge_2N_door", "PoD Arena Back Bridge 2N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Arena Back Bridge 2N Door", "PoD Arena Back Bridge 2N Door"})
PoD_arena_ledge_4E_door = alttp_location.new("PoD_arena_ledge_4E_door", "PoD Arena Ledge 4E Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Arena Ledge 4E Door", "PoD Arena Ledge 4E Door"})
PoD_collapsing_bridge_front_2S_door = alttp_location.new("PoD_collapsing_bridge_front_2S_door", "PoD Collapsing Bridge front 2S Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Door", "PoD Collapsing Bridge front 2S Door", "PoD Collapsing Bridge front 2S Door"})
PoD_collapsing_bridge_back_1W_door = alttp_location.new("PoD_collapsing_bridge_back_1W_door", "PoD Collapsing Bridge Back 1W Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Collapsing Bridge Back 1W Door", "PoD Collapsing Bridge Back 1W Door"})
PoD_dark_maze_2E_door = alttp_location.new("PoD_dark_maze_2E_door", "PoD Dark Maze 2E Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Dark Maze 2E Door", "PoD Dark Maze 2E Door"})
PoD_dark_maze_E_door = alttp_location.new("PoD_dark_maze_E_door", "PoD Dark Maze E Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Dark Maze E Door", "PoD Dark Maze E Door"})
PoD_big_key_chest_ledge_W_door = alttp_location.new("PoD_big_key_chest_ledge_W_door", "PoD Big Key Chest Ledge W Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Big Key Chest Ledge W Door", "PoD Big Key Chest Ledge W Door"})
PoD_compass_room_2N_door = alttp_location.new("PoD_compass_room_2N_door", "PoD Compass Room 2N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Compass Room 2N Door", "PoD Compass Room 2N Door"})
PoD_compass_room_N_door = alttp_location.new("PoD_compass_room_N_door", "PoD Compass Room N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Compass Room N Door", "PoD Compass Room N Door"})
PoD_dark_U_basement_2N_door = alttp_location.new("PoD_dark_U_basement_2N_door", "PoD Dark U Basement 2N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Dark U Basement 2N Door", "PoD Dark U Basement 2N Door"})
PoD_dark_U_basement_N_door = alttp_location.new("PoD_dark_U_basement_N_door", "PoD Dark U Basement N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Dark U Basement N Door", "PoD Dark U Basement N Door"})
PoD_harmless_hellway_4S_door = alttp_location.new("PoD_harmless_hellway_4S_door", "PoD Harmless Hellway 4S Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Harmless Hellway 4S Door", "PoD Harmless Hellway 4S Door"})
PoD_mimics2_3S_door = alttp_location.new("PoD_mimics2_3S_door", "PoD Mimics2 3S Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Mimics2 3S Door", "PoD Mimics2 3S Door"})
PoD_bow_statue_2N_door = alttp_location.new("PoD_bow_statue_2N_door", "PoD Bow Statue 2N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Bow Statue 2N Door", "PoD Bow Statue 2N Door"})
PoD_dark_pegs_2N_door = alttp_location.new("PoD_dark_pegs_2N_door", "PoD Dark Pegs 2N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Dark Pegs 2N Door", "PoD Dark Pegs 2N Door"})
-- local PoD_basement_teleporter_A_side
PoD_boss_room_4S_door = alttp_location.new("PoD_boss_room_4S_door", "PoD Boss Room 4S Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Boss Room 4S Door", "PoD Boss Room 4S Door"})
PoD_dark_inner_basement_2N_door = alttp_location.new("PoD_dark_inner_basement_2N_door", "PoD Dark Inner Basement 2N Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Dark Inner Basement 2N Door", "PoD Dark Inner Basement 2N Door"})
PoD_big_chest_ledge_W_door = alttp_location.new("PoD_big_chest_ledge_W_door", "PoD Big Chest Ledge W Door", nil, "", true, 1,1,1,1, nil, {"Palace of Darkness Doors", "PoD Big Chest Ledge W Door", "PoD Big Chest Ledge W Door"})
...
PoD_entrance_inside:connect_two_ways(PoD_lobby)

PoD_lobby:connect_two_ways(PoD_three_way_room_left, function() return CanInteract(PoD_lobby) end)
PoD_lobby:connect_two_ways(PoD_three_way_room_middle, function() return CanInteract(PoD_lobby) end)
...
PoD_shooter_room_1N_door:connect_two_ways(PoD_shooter_room)
...
PoD_big_key_chest_room:connect_two_ways(PoD_big_key_chest_room_1N_door)
PoD_big_key_chest_room_1N_door:connect_two_ways_entrance("", PoD_arena_left_bridge_3S_door)
PoD_arena_left_bridge_3S_door:connect_two_ways(PoD_arena_left_bridge)
PoD_arena_left_bridge:connect_two_ways(PoD_arena_center)


PoD_big_key_chest_room:connect_two_ways(PoD_big_key_chest_room_2N_door)
PoD_big_key_chest_room_2N_door:connect_two_ways_entrance("", PoD_arena_right_bridge_4S_door)
...
PoD_arena_right_E_door:connect_two_ways_entrance("", PoD_switch_room_bottom_W_door)
PoD_switch_room_bottom_W_door:connect_two_ways(PoD_switch_room_bottom)
...
PoD_dark_U_basement_2N_door:connect_two_ways(PoD_dark_U_basement)
