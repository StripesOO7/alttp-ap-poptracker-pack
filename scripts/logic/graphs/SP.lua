...
SP_first_room_1N_door = alttp_location.new("SP_first_room_1N_door", "SP First Room 1N Door")
SP_pot_row_1N_door = alttp_location.new("SP_pot_row_1N_door", "SP Pot Row 1N Door")
SP_pot_row_1W_door = alttp_location.new("SP_pot_row_1W_door", "SP Pot Row 1W Door")
SP_pot_row_3W_door = alttp_location.new("SP_pot_row_3W_door", "SP Pot Row 3W Door")
SP_map_chest_ledge_2E_door = alttp_location.new("SP_map_chest_ledge_2E_door", "SP Map Chest Ledge 2E Door")
SP_first_trench_4E_door = alttp_location.new("SP_first_trench_4E_door", "SP First Trench 4E Door")
...
SP_shallow_trench_3N_door = alttp_location.new("SP_shallow_trench_3N_door", "SP Shallow Trench 3N Door")
SP_shallow_trench_4E_door = alttp_location.new("SP_shallow_trench_4E_door", "SP Shallow Trench 4E Door")
SP_shallow_water_attic_3N_door = alttp_location.new("SP_shallow_water_attic_3N_door", "SP Shallow Water Attic 3N Door")
SP_shallow_trench_big_key_ledge_2E_door = alttp_location.new("SP_shallow_trench_big_key_ledge_2E_door", "SP Shallow Trench Big Key Ledge 2E Door")
SP_roundabout_N_door = alttp_location.new("SP_roundabout_N_door", "SP Roundabout N Door")
SP_push_statue_room_S_door = alttp_location.new("SP_push_statue_room_S_door", "SP Push Statue Room S Door")
SP_push_statue_room_4N_door = alttp_location.new("SP_push_statue_room_4N_door", "SP Push Statue Room 4N Door")
SP_tiny_hallway_N_door = alttp_location.new("SP_tiny_hallway_N_door", "SP Tiny Hallway N Door")
SP_S_hallway_2N_door = alttp_location.new("SP_S_hallway_2N_door", "SP S Hallway 2N Door")
SP_drain_switch_room_N_door = alttp_location.new("SP_drain_switch_room_N_door", "SP Drain Switch Room N Door")
SP_drain_switch_room_2N_door = alttp_location.new("SP_drain_switch_room_2N_door", "SP Drain Switch Room 2N Door")
SP_basement_shallows_hallway_1N_door = alttp_location.new("SP_basement_shallows_hallway_1N_door", "SP Basement Shallows Hallway 1N Door")
SP_waterfall_room_3S_door = alttp_location.new("SP_waterfall_room_3S_door", "SP Waterfall Room 3S Door")
SP_after_waterfall_room_2N_door = alttp_location.new("SP_after_waterfall_room_2N_door", "SP After Waterfall Room 2N Door")
SP_C_hallway_2N_door = alttp_location.new("SP_C_hallway_2N_door", "SP C Hallway 2N Door")
SP_boss_hallway_1N_door = alttp_location.new("SP_boss_hallway_1N_door", "SP Boss Hallway 1N Door")
SP_boss_room_3S_door = alttp_location.new("SP_boss_room_3S_door", "SP Boss Room 3S Door")
SP_flooded_room_balcony_4N_door =alttp_location.new("SP_flooded_room_balcony_4N_door", "SP Flooded Room Balcony 4N Door")
