...
SP_first_room:connect_one_way("SP - Entrance Enemy #1", function() return DealDamage end)
-- SP_first_room:connect_one_way("SP - Entrance Enemy #2", function() return DealDamage end)
-- SP_first_room:connect_one_way("SP - Entrance Enemy #3", function() return DealDamage end)
-- SP_first_room:connect_one_way("SP - Entrance Enemy #4", function() return DealDamage end)
-- SP_first_room:connect_one_way("SP - Entrance Enemy #5", function() return DealDamage end)
...
SP_pot_row:connect_one_way("SP - Pot Row Key")
SP_pot_row:connect_one_way("SP - Pot Row Pot #1")
-- SP_pot_row:connect_one_way("SP - Pot Row Pot #2")
-- SP_pot_row:connect_one_way("SP - Pot Row Pot #3")
SP_pot_row:connect_one_way("SP - Pot Row Enemy #1", function() return DealDamage end)
-- SP_pot_row:connect_one_way("SP - Pot Row Enemy #2", function() return DealDamage end)
-- SP_pot_row:connect_one_way("SP - Pot Row Enemy #3", function() return DealDamage end)
-- SP_pot_row:connect_one_way("SP - Pot Row Enemy #4", function() return DealDamage end)
-- SP_pot_row:connect_one_way("SP - Pot Row Enemy #5", function() return DealDamage end)
-- SP_pot_row:connect_one_way("SP - Pot Row Enemy #6", function() return DealDamage end)
-- SP_pot_row:connect_one_way("SP - Pot Row Enemy #7", function() return DealDamage end)
...
SP_map_chest_ledge:connect_one_way("SP - Map Ledge Enemy #3", function() return DealDamage end)
-- SP_map_chest_ledge:connect_one_way("SP - Map Ledge Enemy #4", function() return DealDamage end)
...
SP_first_trench:connect_one_way("SP - Trench 1 Approach Enemy #6", function() return DealDamage end)
-- SP_first_trench:connect_one_way("SP - Trench 1 Approach Enemy #7", function() return DealDamage end)
-- SP_first_trench:connect_one_way("SP - Trench 1 Approach Enemy #8", function() return DealDamage end)
-- SP_first_trench:connect_one_way("SP - Trench 1 Approach Enemy #10", function() return DealDamage end)
...
SP_flood_first_trench_room:connect_one_way("SP - Hammer Switch Enemy #2", function() return DealDamage end)
-- SP_flood_first_trench_room:connect_one_way("SP - Hammer Switch Enemy #5", function() return DealDamage end)
...
SP_main_room:connect_one_way("SP - Hub Enemy #2", function() return DealDamage end)
-- SP_main_room:connect_one_way("SP - Hub Enemy #3", function() return DealDamage end)
-- SP_main_room:connect_one_way("SP - Hub Enemy #4", function() return DealDamage end)
-- SP_main_room:connect_one_way("SP - Hub Enemy #6", function() return DealDamage end)
-- SP_main_room:connect_one_way("SP - Hub Enemy #8", function() return DealDamage end)
-- SP_main_room:connect_one_way("SP - Hub Enemy #9", function() return DealDamage end)
...
SP_roundabout:connect_one_way("SP - Donut Bottom Pot #2")
SP_roundabout:connect_one_way("SP - Donut Top Enemy #1", function() return DealDamage end)
SP_roundabout:connect_one_way("SP - Donut Bottom Enemy #3", function() return DealDamage end)
-- SP_roundabout:connect_one_way("SP - Donut Bottom Enemy #5", function() return DealDamage end)
...
SP_flood_second_trench_room:connect_one_way("SP - Crystal Switch Outer Enemy #3", function() return DealDamage end)
-- SP_flood_second_trench_room:connect_one_way("SP - Crystal Switch Outer Enemy #4", function() return DealDamage end)
-- SP_flood_second_trench_room:connect_one_way("SP - Crystal Switch Outer Enemy #5", function() return DealDamage end)
...
SP_second_trench:connect_one_way("SP - Trench 2 Departure Enemy #6", function() return DealDamage end)
SP_second_trench:connect_one_way("SP - Trench 2 Pots Enemy #7", function() return DealDamage end)
-- SP_second_trench:connect_one_way("SP - Trench 2 Pots Enemy #8", function() return DealDamage end)
-- SP_second_trench:connect_one_way("SP - Trench 2 Pots Enemy #10", function() return DealDamage end)
-- SP_second_trench:connect_one_way("SP - Trench 2 Pots Enemy #11", function() return DealDamage end)
...
SP_shallow_trench:connect_one_way("SP - West Shallows Enemy #1", function() return DealDamage end)
-- SP_shallow_trench:connect_one_way("SP - West Shallows Enemy #2", function() return DealDamage end)
-- SP_shallow_trench:connect_one_way("SP - West Shallows Enemy #3", function() return DealDamage end)
-- SP_shallow_trench:connect_one_way("SP - West Shallows Enemy #4", function() return DealDamage end)
-- SP_shallow_trench:connect_one_way("SP - West Shallows Enemy #6", function() return DealDamage end)
-- SP_shallow_trench:connect_one_way("SP - West Shallows Enemy #7", function() return DealDamage end)
SP_shallow_trench:connect_one_way("SP - West Block Path Enemy #5", function() return DealDamage end)
...
SP_shallow_water_attic:connect_one_way("SP - Attic Enemy #1", function() return DealDamage end)
-- SP_shallow_water_attic:connect_one_way("SP - Attic Enemy #2", function() return DealDamage end)
-- SP_shallow_water_attic:connect_one_way("SP - Attic Enemy #3", function() return DealDamage end)
-- SP_shallow_water_attic:connect_one_way("SP - Attic Enemy #4", function() return DealDamage end)
-- SP_shallow_water_attic:connect_one_way("SP - Attic Enemy #5", function() return DealDamage end)
-- SP_shallow_water_attic:connect_one_way("SP - Attic Enemy #6", function() return DealDamage end)
-- SP_shallow_water_attic:connect_one_way("SP - Attic Enemy #7", function() return DealDamage end)
-- SP_shallow_water_attic:connect_one_way("SP - Attic Enemy #8", function() return DealDamage end)
...
SP_push_statue_room:connect_one_way("SP - Push Statue Enemy #9", function() return DealDamage end)
-- SP_push_statue_room:connect_one_way("SP - Push Statue Enemy #10", function() return DealDamage end)
-- SP_push_statue_room:connect_one_way("SP - Push Statue Enemy #11", function() return DealDamage end)
-- SP_push_statue_room:connect_one_way("SP - Push Statue Enemy #12", function() return DealDamage end)
...
SP_tiny_hallway:connect_one_way("SP - Shooters Enemy #3", function() return DealDamage end)
-- SP_tiny_hallway:connect_one_way("SP - Shooters Enemy #4", function() return DealDamage end)
-- SP_tiny_hallway:connect_one_way("SP - Shooters Enemy #5", function() return DealDamage end)
...
SP_S_hallway:connect_one_way("SP - Right Elbow Enemy #2", function() return DealDamage end)
...
SP_basement_shallows_hallway:connect_one_way("SP - Basement Shallows Enemy #2", function() return DealDamage end)
-- SP_basement_shallows_hallway:connect_one_way("SP - Basement Shallows Enemy #3", function() return DealDamage end)
-- SP_basement_shallows_hallway:connect_one_way("SP - Basement Shallows Enemy #4", function() return DealDamage end)
...
SP_flooded_room:connect_one_way("SP - Flooded Room Enemy #5", function() return DealDamage end)
-- SP_flooded_room:connect_one_way("SP - Flooded Room Enemy #7", function() return DealDamage end)
...
SP_waterfall_room:connect_one_way("SP - Refill Enemy #1", function() return DealDamage end)
SP_waterfall_room:connect_one_way("SP - Waterfall Room Enemy #5", function() return DealDamage end)
-- SP_waterfall_room:connect_one_way("SP - Waterfall Room Enemy #7", function() return DealDamage end)
-- SP_waterfall_room:connect_one_way("SP - Waterfall Room Enemy #8", function() return DealDamage end)
-- SP_waterfall_room:connect_one_way("SP - Waterfall Room Enemy #9", function() return DealDamage end)
-- SP_waterfall_room:connect_one_way("SP - Waterfall Room Enemy #10", function() return DealDamage end)
-- SP_waterfall_room:connect_one_way("SP - Waterfall Room Enemy #12", function() return DealDamage end)

SP_waterfall_room:connect_two_ways(SP_after_waterfall_room)

SP_after_waterfall_room:connect_one_way("SP - Behind Waterfall Pot #7")
-- SP_after_waterfall_room:connect_one_way("SP - Behind Waterfall Pot #8")
-- SP_after_waterfall_room:connect_one_way("SP - Behind Waterfall Pot #9")
-- SP_after_waterfall_room:connect_one_way("SP - Behind Waterfall Pot #10")
SP_after_waterfall_room:connect_one_way("SP - Behind Waterfall Enemy #3", function() return DealDamage end)
-- SP_after_waterfall_room:connect_one_way("SP - Behind Waterfall Enemy #4", function() return DealDamage end)
...
SP_C_hallway:connect_one_way("SP - C Enemy #1", function() return DealDamage end)
-- SP_C_hallway:connect_one_way("SP - C Enemy #2", function() return DealDamage end)
-- SP_C_hallway:connect_one_way("SP - C Enemy #3", function() return DealDamage end)
...
SP_heavy_current:connect_one_way("SP - Waterway Enemy #5", function() return DealDamage end)
-- SP_heavy_current:connect_one_way("SP - Waterway Enemy #6", function() return DealDamage end)
-- SP_heavy_current:connect_one_way("SP - Waterway Enemy #7", function() return DealDamage end)
...
SP_I_hallway:connect_one_way("SP - I Enemy #4", function() return DealDamage end)
