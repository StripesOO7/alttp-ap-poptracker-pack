...
SP_first_room_1N_door = alttp_location.new("SP_first_room_1N_door", "SP First Room 1N Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP First Room 1N Door", "SP First Room 1N Door"})
SP_pot_row_1N_door = alttp_location.new("SP_pot_row_1N_door", "SP Pot Row 1N Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Pot Row 1N Door", "SP Pot Row 1N Door"})
SP_pot_row_1W_door = alttp_location.new("SP_pot_row_1W_door", "SP Pot Row 1W Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Pot Row 1W Door", "SP Pot Row 1W Door"})
SP_pot_row_3W_door = alttp_location.new("SP_pot_row_3W_door", "SP Pot Row 3W Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Pot Row 3W Door", "SP Pot Row 3W Door"})
SP_map_chest_ledge_2E_door = alttp_location.new("SP_map_chest_ledge_2E_door", "SP Map Chest Ledge 2E Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Map Chest Ledge 2E Door", "SP Map Chest Ledge 2E Door"})
SP_first_trench_4E_door = alttp_location.new("SP_first_trench_4E_door", "SP First Trench 4E Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP First Trench 4E Door", "SP First Trench 4E Door"})
SP_first_trench_3W_door = alttp_location.new("SP_first_trench_3W_door", "SP First Trench 3W Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP First Trench 3W Door", "SP First Trench 3W Door"})
SP_flood_first_trench_room_1W_door = alttp_location.new("SP_flood_first_trench_room_1W_door", "SP Flood First Trench Room 1W Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Flood First Trench Room 1W Door", "SP Flood First Trench Room 1W Door"})
SP_main_room_north_ledge_N_door = alttp_location.new("SP_main_room_north_ledge_N_door", "SP Main Room North Ledge N Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Main Room North Ledge N Door", "SP Main Room North Ledge N Door"})
SP_main_room_north_east_ledge_E_door = alttp_location.new("SP_main_room_north_east_ledge_E_door", "SP Main Room North East Ledge E Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Main Room North East Ledge E Door", "SP Main Room North East Ledge E Door"})
SP_main_room_1W_door = alttp_location.new("SP_main_room_1W_door", "SP Main Room 1W_door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Main Room 1W_door", "SP Main Room 1W_door"})
SP_main_room_3W_door = alttp_location.new("SP_main_room_3W_door", "SP Main Room 3W_door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Main Room 3W_door", "SP Main Room 3W_door"})
SP_main_room_4E_door = alttp_location.new("SP_main_room_4E_door", "SP Main Room 4E_door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Main Room 4E_door", "SP Main Room 4E_door"})
SP_main_room_S_door = alttp_location.new("SP_main_room_S_door", "SP Main Room S Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Main Room S Door", "SP Main Room S Door"})
SP_flood_second_trench_room_2E_door = alttp_location.new("SP_flood_second_trench_room_2E_door", "SP Flood Second Trench Room 2E Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Flood Second Trench Room 2E Door", "SP Flood Second Trench Room 2E Door"})
SP_second_trench_4E_door = alttp_location.new("SP_second_trench_4E_door", "SP Second Trench 4E Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Second Trench 4E Door", "SP Second Trench 4E Door"})
SP_second_trench_3W_door = alttp_location.new("SP_second_trench_3W_door", "SP Second Trench 3W Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Second Trench 3W Door", "SP Second Trench 3W Door"})
SP_big_key_chest_ledge_1W_door = alttp_location.new("SP_big_key_chest_ledge_1W_door", "SP Big Key Chest Ledge 1W Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Big Key Chest Ledge 1W Door", "SP Big Key Chest Ledge 1W Door"})
SP_shallow_trench_3N_door = alttp_location.new("SP_shallow_trench_3N_door", "SP Shallow Trench 3N Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Shallow Trench 3N Door", "SP Shallow Trench 3N Door"})
SP_shallow_trench_4E_door = alttp_location.new("SP_shallow_trench_4E_door", "SP Shallow Trench 4E Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Shallow Trench 4E Door", "SP Shallow Trench 4E Door"})
SP_shallow_water_attic_3N_door = alttp_location.new("SP_shallow_water_attic_3N_door", "SP Shallow Water Attic 3N Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Shallow Water Attic 3N Door", "SP Shallow Water Attic 3N Door"})
SP_shallow_trench_big_key_ledge_2E_door = alttp_location.new("SP_shallow_trench_big_key_ledge_2E_door", "SP Shallow Trench Big Key Ledge 2E Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Shallow Trench Big Key Ledge 2E Door", "SP Shallow Trench Big Key Ledge 2E Door"})
SP_roundabout_N_door = alttp_location.new("SP_roundabout_N_door", "SP Roundabout N Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Roundabout N Door", "SP Roundabout N Door"})
SP_push_statue_room_S_door = alttp_location.new("SP_push_statue_room_S_door", "SP Push Statue Room S Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Push Statue Room S Door", "SP Push Statue Room S Door"})
SP_push_statue_room_4N_door = alttp_location.new("SP_push_statue_room_4N_door", "SP Push Statue Room 4N Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Push Statue Room 4N Door", "SP Push Statue Room 4N Door"})
SP_tiny_hallway_N_door = alttp_location.new("SP_tiny_hallway_N_door", "SP Tiny Hallway N Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Tiny Hallway N Door", "SP Tiny Hallway N Door"})
SP_S_hallway_2N_door = alttp_location.new("SP_S_hallway_2N_door", "SP S Hallway 2N Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP S Hallway 2N Door", "SP S Hallway 2N Door"})
SP_drain_switch_room_N_door = alttp_location.new("SP_drain_switch_room_N_door", "SP Drain Switch Room N Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Drain Switch Room N Door", "SP Drain Switch Room N Door"})
SP_drain_switch_room_2N_door = alttp_location.new("SP_drain_switch_room_2N_door", "SP Drain Switch Room 2N Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Drain Switch Room 2N Door", "SP Drain Switch Room 2N Door"})
SP_basement_shallows_hallway_1N_door = alttp_location.new("SP_basement_shallows_hallway_1N_door", "SP Basement Shallows Hallway 1N Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Basement Shallows Hallway 1N Door", "SP Basement Shallows Hallway 1N Door"})
SP_waterfall_room_3S_door = alttp_location.new("SP_waterfall_room_3S_door", "SP Waterfall Room 3S Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP Waterfall Room 3S Door", "SP Waterfall Room 3S Door"})
SP_after_waterfall_room_2N_door = alttp_location.new("SP_after_waterfall_room_2N_door", "SP After Waterfall Room 2N Door", nil, "", true, 1,1,1,1, nil, {"Swamp Palace Doors", "SP After Waterfall Room 2N Door", "SP After Waterfall Room 2N Door"})
