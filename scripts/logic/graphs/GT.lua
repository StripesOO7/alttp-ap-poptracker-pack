...
local GT_top_big_key_door = alttp_location.new("GT_top_big_key_door", "GT Top Big Key Door")
...
GT_bottom_main_room_1N_door = alttp_location.new("GT_bottom_main_room_1N_door", "GT Bottom Main Room 1N Door")
GT_bottom_main_room_2N_door = alttp_location.new("GT_bottom_main_room_2N_door", "GT Bottom Main Room 2N Door")
GT_bottom_main_room_N_door = alttp_location.new("GT_bottom_main_room_N_door", "GT Bottom Main Room N Door")
GT_bottom_bobs_torch_1N_door = alttp_location.new("GT_bottom_bobs_torch_1N_door", "GT Bottom Bobs Torch 1N Door")
GT_bottom_bobs_torch_1W_door = alttp_location.new("GT_bottom_bobs_torch_1W_door", "GT Bottom Bobs Torch 1W Door")
GT_bottom_hope_room_2N_door = alttp_location.new("GT_bottom_hope_room_2N_door", "GT Bottom Hope Room 2N Door")
GT_bottom_hope_room_2E_door = alttp_location.new("GT_bottom_hope_room_2E_door", "GT Bottom Hope Room 2E Door")
GT_bottom_conveyor_cross_room_2E_door = alttp_location.new("GT_bottom_conveyor_cross_room_2E_door", "GT Bottom Conveyor Cross Room 2E Door")
GT_bottom_bonk_pit_room_1N_door = alttp_location.new("GT_bottom_bonk_pit_room_1N_door", "GT Bottom Bonk Pit Room 1N Door")
GT_bottom_bonk_pit_room_3S_door = alttp_location.new("GT_bottom_bonk_pit_room_3S_door", "GT Bottom Bonk Pit Room 3S Door")
GT_bottom_dm_room_3S_door = alttp_location.new("GT_bottom_dm_room_3S_door", "GT Bottom DM Room 3S Door")
GT_bottom_double_switch_room_1N_door = alttp_location.new("GT_bottom_double_switch_room_1N_door", "GT Bottom Double Switch Room 1N Door")
GT_bottom_teleporter_puzzle_room_A_side_3W_door = alttp_location.new("GT_bottom_teleporter_puzzle_room_A_side_3W_door", "GT Bottom Teleporter Puzzle Room A side_3W Door")
GT_bottom_teleporter_puzzle_room_A_side_deadend_4S_door = alttp_location.new("GT_bottom_teleporter_puzzle_room_A_side_deadend_4S_door", "GT Bottom Teleporter Puzzle Room A Side Deadend 4S Door")
GT_bottom_teleporter_puzzle_room_B_side_4E_door = alttp_location.new("GT_bottom_teleporter_puzzle_room_B_side_4E_door", "GT Bottom Teleporter Puzzle Room B Side 4E Door")
GT_bottom_randomizer_room_4E_door = alttp_location.new("GT_bottom_randomizer_room_4E_door", "GT Bottom Randomizer Room 4E Door")
GT_bottom_invisibile_bonk_room_1N_door = alttp_location.new("GT_bottom_invisibile_bonk_room_1N_door", "GT Bottom Invisibile Bonk Room 1N Door")
GT_bottom_invisibile_bonk_room_2N_door = alttp_location.new("GT_bottom_invisibile_bonk_room_2N_door", "GT Bottom Invisibile Bonk Room 2N Door")
GT_bottom_invisibile_bonk_room_3W_door = alttp_location.new("GT_bottom_invisibile_bonk_room_3W_door", "GT Bottom Invisibile Bonk Room 3W Door")
GT_bottom_invisibile_bonk_room_4E_door = alttp_location.new("GT_bottom_invisibile_bonk_room_4E_door", "GT Bottom Invisibile Bonk Room 4E Door")
GT_bottom_big_chest_room_isolated_N_door = alttp_location.new("GT_bottom_big_chest_room_isolated_N_door", "GT Bottom Big Chest Room Isolated N Door")
...
GT_bottom_fire_spinner_catwalk_3W_door = alttp_location.new("GT_bottom_fire_spinner_catwalk_3W_door", "GT Bottom Fire Spinner Catwalk 3W Door")
GT_bottom_four_torches_edge_N_door = alttp_location.new("GT_bottom_four_torches_edge_N_door", "GT Bottom Four Torches Edge N Door")
GT_bottom_hidden_star_4E_door = alttp_location.new("GT_bottom_hidden_star_4E_door", "GT Bottom Hidden Star 4E Door")
GT_bottom_invisible_bridges_3W_door = alttp_location.new("GT_bottom_invisible_bridges_3W_door", "GT Bottom Invisible Bridges 3W Door")
...
GT_top_cannonball_bridge_2N_door = alttp_location.new("GT_top_cannonball_bridge_2N_door", "GT Top Cannonball Bridge 2N Door")
GT_top_5_blocks_conveyor_2N_door = alttp_location.new("GT_top_5_blocks_conveyor_2N_door", "GT Top 5 Blocks Conveyor 2N Door")
GT_top_big_circle_conveyor_3S_door = alttp_location.new("GT_top_big_circle_conveyor_3S_door", "GT Top Big Circle Conveyor Door 3S Door")
GT_top_ice_conveyor_1N_door = alttp_location.new("GT_top_ice_conveyor_1N_door", "GT Top Ice Conveyor 1N Door")
GT_top_ice_floor_shooter_3W_door = alttp_location.new("GT_top_ice_floor_shooter_3W_door", "GT Top Ice Floor Shooter 3W Door")
GT_top_pre_desert_refight_4E_door = alttp_location.new("GT_top_pre_desert_refight_4E_door", "GT Top Pre Desert Refight 4E Door")
GT_top_quad_pots_1N_door = alttp_location.new("GT_top_quad_pots_1N_door", "GT Top Quad Pots 1N Door")
GT_top_invisible_floor_wizzrobes_1N_door = alttp_location.new("GT_top_invisible_floor_wizzrobes_1N_door", "GT Top Invisible Floor Wizzrobes 1N Door")
GT_top_center_conveyor_wizzrobes_2N_door = alttp_location.new("GT_top_center_conveyor_wizzrobes_2N_door", "GT Top center Conveyor Wizzrobes 2N Door")
GT_top_dashing_bridge_NS_4S_door = alttp_location.new("GT_top_dashing_bridge_NS_4S_door", "GT Top Dashing Bridge NS 4S Door")
GT_top_dashing_bridge_NS_2E_door = alttp_location.new("GT_top_dashing_bridge_NS_2E_door", "GT Top Dashing Bridge NS 2E Door")
GT_top_torch_puzzle_1W_door = alttp_location.new("GT_top_torch_puzzle_1W_door", "GT Top Torch Puzzle 1W Door")
GT_top_staredown_4N_door = alttp_location.new("GT_top_staredown_4N_door", "GT Top Staredown 4N Door")
GT_top_falling_torches_4S_door = alttp_location.new("GT_top_falling_torches_4S_door", "GT Top Falling Torches 4S Door")
GT_top_crystal_switch_circles_3S_door = alttp_location.new("GT_top_crystal_switch_circles_3S_door", "GT Top Crystal Switch Circles 3S Door")
GT_top_top_refight_1N_door = alttp_location.new("GT_top_top_refight_1N_door", "GT Top Moldorm Refight 1N Door")
GT_top_top_refight_2N_door = alttp_location.new("GT_top_top_refight_2N_door", "GT Top Moldorm Refight 2N Door")
GT_top_below_moldorm_refight_2N_door = alttp_location.new("GT_top_below_moldorm_refight_2N_door", "GT Top Below Moldorm Refight 2N Door")
GT_top_validation_3W_door = alttp_location.new("GT_top_validation_3W_door", "GT Top Validation 3W Door")
GT_top_ice_conveyor_mess_4E_door = alttp_location.new("GT_top_ice_conveyor_mess_4E_door", "GT Top Ice Conveyor Mess 4E Door")
GT_top_ice_conveyor_mess_2N_door = alttp_location.new("GT_top_ice_conveyor_mess_2N_door", "GT Top Ice Conveyor Mess 2N Door")
GT_top_pre_aga2_hallway_1N_door = alttp_location.new("GT_top_pre_aga2_hallway_1N_door", "GT Top Pre Aga2 Hallway 1N Door")
GT_top_pre_aga2_hallway_2N_door = alttp_location.new("GT_top_pre_aga2_hallway_2N_door", "GT Top Pre Aga2 Hallway 2N Door")
GT_top_aga2_3S_door = alttp_location.new("GT_top_aga2_3S_door", "GT Top Aga2 3S Door")
