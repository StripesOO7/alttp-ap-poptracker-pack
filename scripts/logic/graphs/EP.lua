...
EP_main_room_bottom_2E_door = alttp_location.new("EP_main_room_bottom_2E_door", "EP Main Room Bottom 2E door", nil, "EP", true)
EP_main_room_bottom_1W_door = alttp_location.new("EP_main_room_bottom_1W_door", "EP Main Room Bottom 1W door", nil, "EP", true)
EP_east_wing_top_W_door = alttp_location.new("EP_east_wing_top_W_door", "EP East Wing Top W door", nil, "EP", true)
EP_east_wing_bottom_1W_door = alttp_location.new("EP_east_wing_bottom_1W_door", "EP East Wing Bottom 1W door", nil, "EP", true)
...
EP_big_key_chest_room_2E_door = alttp_location.new("EP_big_key_chest_room_2E_door", "EP Big Key Chest Room 2E door", nil, "EP", true)
EP_big_key_chest_room_2N_door = alttp_location.new("EP_big_key_chest_room_2N_door", "EP Big Key Chest Room N door", nil, "EP", true)
EP_west_wing_top_E_door = alttp_location.new("EP_west_wing_top_E_door", "EP West Wing Top E door", nil, "EP", true)
EP_west_wing_bottom_2E_door = alttp_location.new("EP_west_wing_bottom_2E_door", "EP West Wing Bottom 2E door", nil, "EP", true)
EP_west_wing_bottom_4S_door = alttp_location.new("EP_west_wing_bottom_4S_door", "EP West Wing Bottom 4S door", nil, "EP", true)
...
EP_single_eyegore_4E_door = alttp_location.new("EP_single_eyegore_4E_door", "EP Single Eyegore 4E door", nil, "EP", true)
EP_duo_eyegores_2N_door = alttp_location.new("EP_duo_eyegores_2N_door", "EP Duo Eyegores 2N door", nil, "EP", true)
EP_boss_room_4S_door = alttp_location.new("EP_boss_room_4S_door", "EP Boss Room 4S door", nil, "EP", true)
