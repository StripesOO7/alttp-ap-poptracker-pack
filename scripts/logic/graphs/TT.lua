...
TT_front_bottom_left_N_door = alttp_location.new("TT_front_bottom_left_N_door", "TT Front Bottom Left N Door")
TT_front_bottom_left_2N_door = alttp_location.new("TT_front_bottom_left_2N_door", "TT Front Bottom Left 2N Door")
TT_front_bottom_left_E_door = alttp_location.new("TT_front_bottom_left_E_door", "TT Front Bottom Left E Door")
TT_front_bottom_left_deadend_4E_door = alttp_location.new("TT_front_bottom_left_deadend_4E_door", "TT Front Bottom Left Deadend 4E Door")
TT_front_top_left_S_door = alttp_location.new("TT_front_top_left_S_door", "TT Front Top Left S Door")
TT_front_top_left_4S_door = alttp_location.new("TT_front_top_left_4S_door", "TT Front Top Left 4S Door")
TT_front_top_left_2E_door = alttp_location.new("TT_front_top_left_2E_door", "TT Front Top Left 2E Door")
TT_front_top_left_4E_door = alttp_location.new("TT_front_top_left_4E_door", "TT Front Top Left 4E Door")
TT_front_top_left_E_door = alttp_location.new("TT_front_top_left_E_door", "TT Front Top Left E Door")
TT_front_top_right_1W_door = alttp_location.new("TT_front_top_right_1W_door", "TT Front Top Right 1W Door")
TT_front_top_right_3W_door = alttp_location.new("TT_front_top_right_3W_door", "TT Front Top Right 3W Door")
TT_front_top_right_W_door = alttp_location.new("TT_front_top_right_W_door", "TT Front Top Right W Door")
TT_front_top_right_S_door = alttp_location.new("TT_front_top_right_S_door", "TT Front Top Right S Door")
TT_front_top_right_3S_door = alttp_location.new("TT_front_top_right_3S_door", "TT Front Top Right 3S Door")
TT_front_top_right_1N_door = alttp_location.new("TT_front_top_right_1N_door", "TT Front Top Right 1N Door")
TT_front_top_right_2N_door = alttp_location.new("TT_front_top_right_2N_door", "TT Front Top Right 2N Door")
TT_front_bottom_right_1N_door = alttp_location.new("TT_front_bottom_right_1N_door", "TT Front Bottom Right 1N Door")
...
TT_crystal_switch_room_S_door = alttp_location.new("TT_crystal_switch_room_S_door", "TT Crystal Switch Room S Door")
TT_attic_N_door = alttp_location.new("TT_attic_N_door", "TT Attic N Door")
TT_attic_E_door = alttp_location.new("TT_attic_E_door", "TT Attic E Door")
TT_attic_bomb_floor_W_door = alttp_location.new("TT_attic_bomb_floor_W_door", "TT Attic Bomb Floor W Door")
TT_big_block_basement_N_door = alttp_location.new("TT_big_block_basement_N_door", "TT Big Block Basement N Door")
TT_big_block_basement_1W_door = alttp_location.new("TT_big_block_basement_1W_door", "TT Big Block Basement 1W Door")
TT_conveyor_catwalk_2E_door = alttp_location.new("TT_conveyor_catwalk_2E_door", "TT Conveyor Catwalk 2E Door")
TT_conveyor_catwalk_4E_door = alttp_location.new("TT_conveyor_catwalk_4E_door", "TT Conveyor Catwalk 4E Door")
TT_big_pot_hall_4W_door = alttp_location.new("TT_big_pot_hall_4W_door", "TT Big Pot Hall_4W Door")
