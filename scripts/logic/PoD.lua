...
pod_entrance:connect_two_ways(pod_three_way_room_left, function() return can_interact("dark") end)
pod_entrance:connect_two_ways(pod_three_way_room_middle, function() return can_interact("dark") end)
pod_entrance:connect_two_ways(pod_three_way_room_right, function() return can_interact("dark") end)
