...
local pod_three_way_room_left = alttp_location.new("pod_three_way_room_left", nil, nil, true)
local pod_three_way_room_middle = alttp_location.new("pod_three_way_room_middle", nil, nil, true)
local pod_three_way_room_right = alttp_location.new("pod_three_way_room_right", nil, nil, true)
local pod_shooter_room = alttp_location.new("pod_shooter_room", nil, nil, true)
local pod_teleporter_room = alttp_location.new("pod_teleporter_room", nil, nil, true)
local pod_mimic_room = alttp_location.new("pod_mimic_room", nil, nil, true)
local pod_switch_room_top = alttp_location.new("pod_switch_room_top", nil, nil, true)
local pod_switch_room_bottom = alttp_location.new("pod_switch_room_bottom", nil, nil, true)
local pod_arena = alttp_location.new("pod_arena", nil, nil, true)
local pod_big_key_chest_room = alttp_location.new("pod_big_key_chest_room", nil, nil, true)
local pod_basement_ledge = alttp_location.new("pod_basement_ledge", nil, nil, true)
local pod_basement_floor = alttp_location.new("pod_basement_floor", nil, nil, true)
local pod_big_key_chest_ledge = alttp_location.new("pod_big_key_chest_ledge", nil, nil, true)
local pod_collapsin_bridge = alttp_location.new("pod_collapsin_bridge", nil, nil, true)
local pod_dark_maze = alttp_location.new("pod_dark_maze", nil, nil, true)
local pod_compass_room = alttp_location.new("pod_compass_room", nil, nil, true)
local pod_dark_basement = alttp_location.new("pod_dark_basement", nil, nil, true)
