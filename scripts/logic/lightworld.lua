...
light_spawn_old_man:connect_one_way(old_man_cave_inside, function() return openOrStandard() end)
...
kakariko_village:connect_two_ways(kakariko_house_hill_top_outside)
kakariko_village:connect_two_ways(kakariko_house_top_left_outside)
kakariko_village:connect_two_ways(kakariko_house_right_top_outside)
kakariko_village:connect_two_ways(kakariko_house_right_center_outside, function() return can_interact("light", 1) end)
...
kakariko_house_hill_top_outside:connect_two_ways_entrance("Kakariko Hill House", kakariko_house_hill_top_inside)
kakariko_house_top_left_outside:connect_two_ways_entrance("Kakariko House Top Left", kakariko_house_top_left_inside)
kakariko_house_right_top_outside:connect_two_ways_entrance("Kakariko House Top Right", kakariko_house_right_top_inside)
kakariko_house_right_center_outside:connect_two_ways_entrance("Kakariko House Center Right", kakariko_house_right_center_inside)
...
kakariko_blinds_hideout_inside:connect_one_way("Blind's Hideout - Back", function() return has("bombs") end)
...
south_of_village:connect_two_ways(archery_minigame_outside)
...
archery_minigame_outside:connect_two_ways_entrance("Light Archery Mini Game", archery_minigame_inside)
...
sanctuary_area:connect_two_ways(sanctuary_bonk_pile_cave_outside)
sanctuary_bonk_pile_cave_outside:connect_two_ways_entrance("Bonk Pile Cave", sanctuary_bonk_pile_cave_inside, function() 
    return all(
        has("boots"), 
        can_interact("light",1 )
    ) 
...
sanctuary_entrance_outside:connect_two_ways_entrance("Sanctuary Entrance", sanctuary_entrance_inside)
...
ce_dropdown_entrance_outside:connect_one_way_entrance("Castel Escape Dropdown", ce_dropdown_entrance_inside)
...
lost_woods:connect_two_ways(lost_woods_top_outside)
...
lost_woods_top_outside:connect_two_ways_entrance("Lost Woods Top", lost_woods_top_inside)
lost_woods:connect_two_ways_entrance("Pedestal Glade", lost_woods_pedestal)

lost_woods_hideout_hole_inside:connect_one_way(lost_woods_hideout_item)
...
dam_area:connect_two_ways(dam_top_right_cave_outside, function() 
    return all(
        has("bombs"), 
        can_interact("light",1 )
    ) 
...
dam_area:connect_two_ways(twenty_rupee_thief_outside, function() 
    return all(
        has("glove"), 
        can_interact("light",1 )
    ) 
...
dam_top_right_cave_outside:connect_two_ways_entrance("Dam Area Top Cave", dam_top_right_cave_inside)
dam_desert_fairy_outside:connect_two_ways_entrance("Dam Fairy", dam_desert_fairy_inside)
twenty_rupee_thief_outside:connect_two_ways_entrance("Dam 20 Rupee Cave", twenty_rupee_thief_inside)
...
desert_area:connect_one_way(dp_main_entrance_outside, function() 
    return all(
        has("book"), 
        can_interact("light",1 )
    ) 
...
dp_right_entrance_outside:connect_one_way(desert_ledge)
...
lumberjacks_area:connect_two_ways_entrance("Lower Light Death Mountain Ascent Ledge", light_death_mountain_ascent_ledge, function() 
 ...
 -- rescue old man
---------------- HARD TO DO -------------
inverted_bumper_cave_outside:connect_one_way(light_bumper_cave_ledge, function() 
    return all(
        inverted(), 
        has("cape"), 
        can_interact("light",1 )
...
light_lake_hylia:connect_two_ways(icerod_fairy_outside)
light_lake_hylia:connect_two_ways(icerod_stone_outside, function() 
    return all(
        has("glove"), 
        can_interact("light",1 )
    ) 
...
icerod_cave_outside:connect_two_ways_entrance("Icerod Cave", icerod_cave_inside, function() 
    return all(
        has("bombs"), 
        can_interact("light",1 )
    ) 
end)
icerod_fairy_outside:connect_two_ways_entrance("Icerod Fairy", icerod_fairy_inside)
icerod_stone_outside:connect_two_ways_entrance("Icerod Stone", icerod_stone_inside, function() 
    return all(
        has("glove"), 
        can_interact("light",1 )
    ) 
...
links_house_area:connect_two_ways(links_house_outside)
links_house_area:connect_two_ways(links_fairy_fountain_outside)

links_house_outside:connect_two_ways_entrance("Link's House", links_house_inside, function() return openOrStandard() end)
links_house_outside:connect_two_ways_entrance("Big Bomb Shop", big_bomb_shop_inside, function() return inverted() end)
links_fairy_fountain_outside:connect_two_ways_entrance("Links Fairy", links_fairy_fountain_inside, function() 
    return all(
        has("boots"), 
        can_interact("light",1)
    ) 
...
eastern_palace_area:connect_two_ways(eastern_fairy_outside, function() 
    return all(
        has("bombs"), 
        can_interact("light",1 )
    ) 
...
eastern_fairy_outside:connect_two_ways_entrance("Easter Fairy", eastern_fairy_inside)
...
hyrule_castle_area:connect_two_ways(secret_passage_stairs_outside)
...
gt_entrance_outside:connect_two_ways_entrance("Inverted Ganons Tower", gt_entrance_inside, function() 
    return all(
        gtCrystalCount(),
        inverted()
    ) 
...
light_potion_shop_inside:connect_one_way("Deliver Mushroom", function() 
    return all(
        has("mushroom"), 
        CanReach(light_potion_shop_inside)
    ) 
end)
...
light_death_mountain_left_bottom:connect_two_ways(old_man_cave_outside)
light_death_mountain_left_bottom:connect_two_ways(spec_rock_top_entrance_outside)
light_death_mountain_left_bottom:connect_two_ways(old_man_cave_back_outside)
...
old_man_cave_outside:connect_two_ways_entrance("Old Man Cave Entrance", old_man_cave_inside)
light_death_mountain_left_bottom:connect_two_ways_entrance("Spectecal Rock Top Entrance", spec_rock_top_entrance)
old_man_cave_back_outside:connect_two_ways_entrance("Old Man Cave Backside", old_man_cave_back_inside)
...
old_man_cave_inside:connect_two_ways(old_man_cave_back_inside, function() return darkRooms() end)
...
light_death_mountain_right_top:connect_one_way(light_eyebridge_fairy_outside, function() return inverted() end)
...
paradox_cave_bottom_entrance_inside:connect_one_way(paradox_cave_bottom_back) -- fall down
paradox_cave_bottom_entrance_inside:connect_two_ways(paradox_cave_top_entrance_inside) -- stairs up left
...
paradox_cave_bottom_shop_entrance:connect_one_way(light_death_mountain_shop_inside, function() return has("bombs") end) -- go to shop and bomb it open
