...
teleporter_at_dark_death_mountain_left_bottom:connect_one_way(teleporter_at_light_death_mountain_left_bottom, Inverted)

teleporter_at_dark_death_mountain_right_bottom:connect_one_way(teleporter_at_light_death_mountain_right_bottom, Inverted)
...
teleporter_at_ice_palace:connect_one_way(teleporter_at_upgrade_fairy, Inverted)
...
dark_spawn_links_house:connect_one_way(links_house_inside, Inverted)
-- dark_spawn_links_house:connect_two_ways_entrance("Big Bomb Shop", big_bomb_shop, OpenOrStandard)
dark_spawn_dark_chapel:connect_one_way(dark_chapel_inside, Inverted)
dark_spawn_old_man:connect_one_way(old_man_home_bottom_inside, Inverted)
...
big_bomb_shop_outside:connect_two_ways_entrance("Big Bomb Shop", big_bomb_shop_inside, OpenOrStandard)
big_bomb_shop_outside:connect_two_ways_entrance("Big Bomb Shop", links_house_inside, Inverted)

big_bomb_shop_area:connect_two_ways_stuck(big_bomb_shop_fairy_cave_outside, function()
    return ALL(
        "boots",
        CanInteract(big_bomb_shop_area.worldstate, 0)
    )
end)
...
big_bomb_shop_inside:connect_one_way("Buy Big Bomb", function() return ALL(Has("crystal56",2, 2, 2, 2), CanInteract(big_bomb_shop_inside.worldstate, 0)) end)
...
swamp_area:connect_one_way(teleporter_at_swamp, function()
    return ALL(
        Inverted,
        "hammer",
        CanInteract(swamp_area.worldstate, 0)
    )
end)
teleporter_at_swamp:connect_one_way(swamp_area, function()
    return ALL(
        "pearl",
        "hammer",
        CanInteract(teleporter_at_swamp.worldstate, 0)
    )
end)
...
hype_cave_inside:connect_two_ways(hype_cave_back, function() 
    return ALL(
        "bombs",
        CanInteract(hype_cave_inside.worldstate, 0)
    )
end)
...
mire_area:connect_two_ways_stuck(mm_entrance_outside, function()
    return ALL(
        ...
        CanUseMedallions,
        CanInteract(mire_area.worldstate, 0)
    )
end)
...
mire_shed_inside:connect_one_way("Mire Shed Left", function() return CanInteract(mire_shed_inside.worldstate, 0) end)
mire_shed_inside:connect_one_way("Mire Shed Right", function() return CanInteract(mire_shed_inside.worldstate, 0) end)
...
dark_lake_hylia:connect_one_way(dark_icerod_area, function()
    return ALL(
        "flippers",
        CanInteract(dark_lake_hylia.worldstate, 0)
    )
end)
...
dark_icerod_area:connect_one_way(ice_palace_island, function()
    return ALL(
        Inverted,
        "flippers",
        CanInteract(dark_icerod_area.worldstate, 0)
    )
end)
...
dark_icerod_area:connect_two_ways_stuck(dark_lake_hylia_ledge_fairy_outside, function() return ALL("bombs", CanInteract(dark_icerod_area.worldstate, 0)) end)
dark_icerod_area:connect_two_ways(dark_lake_hylia_ledge_hint_outside)
dark_icerod_area:connect_two_ways_stuck(dark_lake_hylia_ledge_spike_hint_outside, function() return ALL("glove", CanInteract(dark_icerod_area.worldstate, 0)) end)
...
village_of_the_outcast:connect_two_ways(tt_entrance_outside, function() return CanInteract(village_of_the_outcast.worldstate, 0) end) -- maybe perl????
village_of_the_outcast:connect_two_ways(dark_village_shop_outside, function() return ALL("hammer", CanInteract(village_of_the_outcast.worldstate, 0)) end)
village_of_the_outcast:connect_two_ways_stuck(brewery_outside, function() return ALL("bombs", CanInteract(village_of_the_outcast.worldstate, 0)) end)
...
chest_game_inside:connect_one_way("Chest Game Item", function() return CanInteract(chest_game_inside.worldstate, 0) end)

c_shaped_house_inside:connect_one_way("C-Shaped House", function() return CanInteract(c_shaped_house_inside.worldstate, 0) end)
...
brewery_inside:connect_one_way("Brewery Chest", function() return CanInteract(brewery_inside.worldstate, 0) end)


village_of_the_outcast:connect_two_ways(purple_chest_pickup, function() return ALL("titans", CanInteract(village_of_the_outcast.worldstate, 0)) end)
purple_chest_pickup:connect_two_ways_stuck(peg_cave_outside, function() return ALL("hammer", CanInteract(purple_chest_pickup.worldstate, 0)) end)
...
village_of_the_outcast:connect_two_ways(helpless_frog, function() return ALL("titans", CanInteract(village_of_the_outcast.worldstate, 0)) end)

-- south_of_village_of_the_outcast
south_of_village_of_the_outcast:connect_one_way(village_of_the_outcast, function()
    return ALL(
        "titans",
        CanInteract(south_of_village_of_the_outcast.worldstate, 0)
    )
end)
...
south_of_village_of_the_outcast:connect_one_way("Digging Game", function() return CanInteract(south_of_village_of_the_outcast.worldstate, 0) end)
...
big_bomb_shop_area:connect_two_ways(stumpy, function() return CanInteract(big_bomb_shop_area.worldstate, 0) end)
big_bomb_shop_area:connect_one_way(cave45_ledge, function()
    return ALL(
        OpenOrStandard,
        CanChangeWorldWithMirror
...
skull_woods_area:connect_two_ways(sw_pot_circle_drop_outside, function() return CanInteract(skull_woods_area.worldstate, 0) end)
...
skull_woods_area_back:connect_two_ways(sw_north_drop_outside, function() return ALL(CanReach("sw_west_lobby_entrance_outside"), CanInteract(skull_woods_area_back.worldstate, 0)) end)
skull_woods_area_back:connect_two_ways_stuck(sw_back_entrance_outside, function()
    return ALL(
        CanReach("sw_west_lobby_entrance_outside"),
        "firerod",
        CanInteract(skull_woods_area_back.worldstate, 0)
    )
end)
...
dark_lumpberjacks:connect_two_ways(dark_bumper_cave_bottom_ledge, function()
    return ALL(
        "glove",
        CanInteract(dark_lumpberjacks.worldstate, 0)
    )
end)
...
-- dark_bumper_cave_outside:connect_two_ways_entrance("Bumper Cave", dark_bumper_cave_inside, function() return ALL(OpenOrStandard, "glove", CanInteract("dark",1 )) end)
...
dark_bumper_cave_bottom_outside:connect_two_ways_entrance("Bumper Cave Bottom", dark_bumper_cave_bottom_inside, OpenOrStandard)
dark_bumper_cave_bottom_outside:connect_two_ways_entrance("Old Man Cave Left", old_man_cave_left_inside, Inverted)
...
bumpercave_top_back:connect_two_ways(bumpercave_top_front, function()
    return ALL(
        "cape",
        CanInteract(bumpercave_top_back.worldstate, 0)
    )
end)
bumpercave_top_front:connect_two_ways(dark_bumper_cave_top_inside)

dark_bumper_cave_top_outside:connect_two_ways_entrance("Bumper Cave Top", dark_bumper_cave_top_inside, OpenOrStandard)
dark_bumper_cave_top_outside:connect_two_ways_entrance("Dark Death Mountain Fairy Inside", dark_death_mountain_fairy_inside, Inverted)
...
-- dark_bumper_cave_outside:connect_one_way_entrance("Normal Bumpercave", dark_bumper_cave_ledge,function() return ALL(OpenOrStandard(), "cape", CanInteract("dark",1 )) end)
...
dark_chapel_area:connect_one_way(dark_potion_shop_area, function()
    return ALL(
        "flippers",
        CanInteract(dark_chapel_area.worldstate, 0)
    )
end)
...
dark_potion_shop_area:connect_one_way(dark_chapel_area, function()
    return ALL(
        "hookshot",
        CanInteract(dark_potion_shop_area.worldstate, 0)
    )
end)
...
catfish_area:connect_one_way(dark_potion_shop_area, function()
    return ALL(
        ...
        CanInteract(catfish_area.worldstate, 0)
    )
end)
...
catfish_area:connect_one_way("Catfish Item", function() return CanInteract(catfish_area.worldstate, 0) end)
...
pyramid:connect_two_ways_stuck(pyramid_fairy_cave_outside, function()
    return ALL(
        ...
        CanInteract(pyramid.worldstate, 0),
        ANY(
            ALL(
                "mirror",
                Inverted
...
pyramid_exit_outside:connect_two_ways(pyramid_exit_ledge, OpenOrStandard)
...
pyramid_fairy_cave_inside:connect_one_way("Pyramid Fairy Left", function() return CanInteract(pyramid_fairy_cave_inside.worldstate, 0) end)
pyramid_fairy_cave_inside:connect_one_way("Pyramid Fairy Right", function() return CanInteract(pyramid_fairy_cave_inside.worldstate, 0) end)
...
pod_area:connect_one_way(dark_potion_shop_area,function()
    return ALL(
        ...
        CanInteract(pod_area.worldstate, 4)
    )
end)
...
gt_entrance_outside:connect_two_ways_entrance("Ganons Tower", gt_entrance_inside, OpenOrStandard)
gt_entrance_outside:connect_two_ways_entrance("Aga Tower", at_entrance_inside, Inverted)
...
dark_death_mountain_right_top:connect_two_ways_stuck(hookshot_cave_outside, function()
    return ANY(
        ALL(
            "glove",
            CanInteract(dark_death_mountain_right_top.worldstate, 0)
        )
    )
end)
...
hookshot_cave_inside:connect_two_ways(dark_floating_island_inside, function()
    return ALL(
        "bombs",
        CanInteract(hookshot_cave_inside.worldstate, 0)
    )
end)
...
hookshot_cave_inside:connect_one_way("Hookshot Cave Item Bottom Right", function()
    return ALL(
        ...
        CanInteract(hookshot_cave_inside.worldstate, 4)
    )
end)
...
dark_death_mountain_left_bottom:connect_one_way(teleporter_at_dark_death_mountain_left_bottom, Inverted)
...
spike_cave_inside:connect_one_way("Spike Cave Chest", function()
    return ALL(
        "hammer",
        "glove",
        CanInteract(spike_cave_inside.worldstate, 4) --,
        -- Has("heartpieces", )
    )
end)
dark_death_mountain_left_bottom:connect_one_way(dark_death_mountain_left_top, Inverted)

dark_death_mountain_left_bottom:connect_two_ways(dark_death_mountain_fairy_outside)

dark_death_mountain_fairy_outside:connect_two_ways_entrance("Dark Death Mountain Fairy", dark_death_mountain_fairy_inside, OpenOrStandard)

dark_death_mountain_fairy_outside:connect_two_ways_entrance("Old Man Cave Right Inside", old_man_cave_right_inside, Inverted)
...
turtle_rock_ledge:connect_two_ways(tr_laser_entrance_outside, function()
    return ALL(
        "bombs",
        CanInteract(turtle_rock_ledge.worldstate, 0)
    )
end)
