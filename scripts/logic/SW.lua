...
sw_pot_circle:connect_one_way(sw_map_room, function() return CanInteract(sw_pot_circle.worldstate, 0) end)
...
sw_big_chest_entrance_inside:connect_one_way("SW - Big Chest", function()
    return ALL(
        "sw_bigkey",
        "bombs",
        CanInteract(sw_big_chest_entrance_inside.worldstate, 0)
    )
end)
