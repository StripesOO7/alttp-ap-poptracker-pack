...
local sw_compass_room = alttp_location.new("sw_compass_room", nil, nil, true)
local sw_pot_prison = alttp_location.new("sw_pot_prison", nil, nil, true)
local sw_pinball_room = alttp_location.new("sw_pinball_room", nil, nil, true)
local sw_bottom_left_room = alttp_location.new("sw_bottom_left_room", nil, nil, true)
local sw_map_room = alttp_location.new("sw_map_room", nil, nil, true)
local sw_pot_circle = alttp_location.new("sw_pot_circle", nil, nil, true)
local sw_big_key_room = alttp_location.new("sw_big_key_room", nil, nil, true)
local sw_back_bridge = alttp_location.new("sw_back_bridge", nil, nil, true)
local sw_back_bottom_hallway = alttp_location.new("sw_back_bottom_hallway", nil, nil, true)
local sw_back_troch_puzzle = alttp_location.new("sw_back_troch_puzzle", nil, nil, true)
local sw_back_spike_corner_room = alttp_location.new("sw_back_spike_corner_room", nil, nil, true)
local sw_back_boss_room = alttp_location.new("sw_back_boss_room", nil, nil, true)
