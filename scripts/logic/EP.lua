...
local ep_cannonball_room = alttp_location.new("ep_cannonball_room", nil, nil, true)
local ep_main_room_top = alttp_location.new("ep_main_room_top", nil, nil, true)
local ep_map_chest_room = alttp_location.new("ep_map_chest_room", nil, nil, true)
local ep_compass_chest_room = alttp_location.new("ep_compass_chest_room", nil, nil, true)
local ep_main_room_bottom = alttp_location.new("ep_main_room_bottom", nil, nil, true)
local ep_dark_square_room = alttp_location.new("ep_dark_square_room", nil, nil, true)
local ep_big_key_chest_room = alttp_location.new("ep_big_key_chest_room", nil, nil, true)
