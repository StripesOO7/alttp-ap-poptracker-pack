...
ip_jelly_room:connect_two_ways(ip_push_cross, function(keys) return has("ip_smallkey", keys, 0, keys + 1, 1), KDS(keys, keys + 1) end)
...
ip_conveyor_room:connect_two_ways(ip_spliding_penguins, function(keys) return has("ip_smallkey", keys, 0, keys + 1, 2), KDS(keys, keys + 1) end)
...
ip_cross:connect_two_ways(ip_spike_room, function(keys) return has("ip_smallkey", keys + 1, 2, keys + 1, 4), KDS(keys + 1, keys + 1) end)
...
ip_iced_t_room:connect_two_ways(ip_ice_hallway, function(keys) return has("ip_smallkey", keys + 1, 2, keys + 1, 4), KDS(keys + 1, keys + 1) end)
