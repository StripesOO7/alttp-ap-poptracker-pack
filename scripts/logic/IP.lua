...
ip_entrance:connect_two_ways(ip_freezor_entrance, function() return can_interact("dark", 1) end)
...
ip_cross:connect_two_ways(ip_spike_room, function(keys) 
    if Tracker:FindObjectForCode("ip_bigkey").Active then
